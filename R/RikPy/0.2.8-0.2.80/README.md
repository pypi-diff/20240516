# Comparing `tmp/RikPy-0.2.8.tar.gz` & `tmp/RikPy-0.2.80.tar.gz`
...
## Comparing `RikPy-0.2.8.tar` & `RikPy-0.2.80.tar`
...
### Comparing `RikPy-0.2.8/RikPy/commongoogle.py` & `RikPy-0.2.80/RikPy/commongoogle.py`

 * *Files identical despite different names*

### Comparing `RikPy-0.2.8/RikPy/commonheroku.py` & `RikPy-0.2.80/RikPy/commonheroku.py`
