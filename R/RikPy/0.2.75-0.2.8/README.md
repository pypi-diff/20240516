# Comparing `tmp/RikPy-0.2.75.tar.gz` & `tmp/RikPy-0.2.8.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "RikPy-0.2.75.tar", last modified: Thu May 16 17:36:01 2024, max compression
+gzip compressed data, was "RikPy-0.2.8.tar", last modified: Wed Jan 17 12:45:23 2024, max compression
```

## Comparing `RikPy-0.2.75.tar` & `RikPy-0.2.8.tar`

### file list

```diff
@@ -1,23 +1,16 @@
-drwxrwxrwx   0        0        0        0 2024-05-16 17:36:01.111176 RikPy-0.2.75/
--rw-rw-rw-   0        0        0      222 2024-02-01 13:41:35.000000 RikPy-0.2.75/MANIFEST.in
--rw-rw-rw-   0        0        0      176 2024-05-16 17:36:01.109181 RikPy-0.2.75/PKG-INFO
-drwxrwxrwx   0        0        0        0 2024-05-16 17:36:01.079261 RikPy-0.2.75/RikPy/
--rw-rw-rw-   0        0        0        0 2024-01-13 10:28:52.000000 RikPy-0.2.75/RikPy/__init__.py
--rw-rw-rw-   0        0        0     5079 2024-02-27 11:46:00.000000 RikPy-0.2.75/RikPy/commonfunctions.py
--rw-rw-rw-   0        0        0     2982 2024-01-14 10:37:23.000000 RikPy-0.2.75/RikPy/commongoogle.py
--rw-rw-rw-   0        0        0    12762 2024-02-02 12:54:14.000000 RikPy-0.2.75/RikPy/commonheroku.py
--rw-rw-rw-   0        0        0     6672 2024-05-03 09:32:48.000000 RikPy-0.2.75/RikPy/commonleonardo.py
--rw-rw-rw-   0        0        0      322 2024-02-02 09:53:19.000000 RikPy-0.2.75/RikPy/commonlogging.py
--rw-rw-rw-   0        0        0     4062 2024-05-16 17:32:02.000000 RikPy-0.2.75/RikPy/commonopenai.py
--rw-rw-rw-   0        0        0     7919 2024-02-07 12:06:25.000000 RikPy-0.2.75/RikPy/commons3.py
--rw-rw-rw-   0        0        0    63072 2024-05-06 15:05:51.000000 RikPy-0.2.75/RikPy/commonshopify.py
--rw-rw-rw-   0        0        0      302 2024-02-10 20:05:58.000000 RikPy-0.2.75/RikPy/customresponse.py
-drwxrwxrwx   0        0        0        0 2024-05-16 17:36:01.107186 RikPy-0.2.75/RikPy.egg-info/
--rw-rw-rw-   0        0        0      176 2024-05-16 17:36:00.000000 RikPy-0.2.75/RikPy.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      389 2024-05-16 17:36:00.000000 RikPy-0.2.75/RikPy.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2024-05-16 17:36:00.000000 RikPy-0.2.75/RikPy.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0        6 2024-05-16 17:36:00.000000 RikPy-0.2.75/RikPy.egg-info/top_level.txt
--rw-rw-rw-   0        0        0     2643 2024-02-28 23:25:52.000000 RikPy-0.2.75/logfile.txt
--rw-rw-rw-   0        0        0        0 2024-01-13 10:22:02.000000 RikPy-0.2.75/readme.md
--rw-rw-rw-   0        0        0      295 2024-05-16 17:36:01.117161 RikPy-0.2.75/setup.cfg
--rw-rw-rw-   0        0        0       56 2024-01-30 10:46:18.000000 RikPy-0.2.75/setup.py
...
### Comparing `RikPy-0.2.75/RikPy/commongoogle.py` & `RikPy-0.2.8/RikPy/commongoogle.py`

 * *Files identical despite different names*

### Comparing `RikPy-0.2.75/RikPy/commonheroku.py` & `RikPy-0.2.8/RikPy/commonheroku.py`
