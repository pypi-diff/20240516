# Comparing `tmp/mongo_exporter-1.5.5.tar.gz` & `tmp/mongo_exporter-1.5.6.tar.gz`
...
## Comparing `mongo_exporter-1.5.5.tar` & `mongo_exporter-1.5.6.tar`
...
### Comparing `mongo_exporter-1.5.5/README.md` & `mongo_exporter-1.5.6/README.md`

 * *Files identical despite different names*

### Comparing `mongo_exporter-1.5.5/mongo_exporter/tools.py` & `mongo_exporter-1.5.6/mongo_exporter/tools.py`
