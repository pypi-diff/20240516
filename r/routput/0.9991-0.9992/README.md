# Comparing `tmp/routput-0.9991.tar.gz` & `tmp/routput-0.9992.tar.gz`
...
## Comparing `routput-0.9991.tar` & `routput-0.9992.tar`
...
### Comparing `routput-0.9991/LICENCE` & `routput-0.9992/LICENCE`

 * *Files identical despite different names*

### Comparing `routput-0.9991/PKG-INFO` & `routput-0.9992/PKG-INFO`
...
### Comparing `routput-0.9991/README.md` & `routput-0.9992/README.md`

 * *Files identical despite different names*

### Comparing `routput-0.9991/_README.py` & `routput-0.9992/_README.py`

 * *Files identical despite different names*

### Comparing `routput-0.9991/_pickled.py` & `routput-0.9992/_pickled.py`
...
### Comparing `routput-0.9991/routput.egg-info/PKG-INFO` & `routput-0.9992/routput.egg-info/PKG-INFO`
...
### Comparing `routput-0.9991/templated_setup.py` & `routput-0.9992/templated_setup.py`
