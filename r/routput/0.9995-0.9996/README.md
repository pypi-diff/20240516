# Comparing `tmp/routput-0.9995.tar.gz` & `tmp/routput-0.9996.tar.gz`
...
## Comparing `routput-0.9995.tar` & `routput-0.9996.tar`
...
### Comparing `routput-0.9995/LICENCE` & `routput-0.9996/LICENCE`

 * *Files identical despite different names*

### Comparing `routput-0.9995/PKG-INFO` & `routput-0.9996/PKG-INFO`
...
### Comparing `routput-0.9995/README.md` & `routput-0.9996/README.md`

 * *Files identical despite different names*

### Comparing `routput-0.9995/routput/_README.py` & `routput-0.9996/routput/_README.py`

 * *Files identical despite different names*

### Comparing `routput-0.9995/routput/_pickled.py` & `routput-0.9996/routput/_pickled.py`
...
### Comparing `routput-0.9995/routput/routput.py` & `routput-0.9996/routput/routput.py`

 * *Files identical despite different names*

### Comparing `routput-0.9995/routput.egg-info/PKG-INFO` & `routput-0.9996/routput.egg-info/PKG-INFO`
...
### Comparing `routput-0.9995/templated_setup.py` & `routput-0.9996/templated_setup.py`
