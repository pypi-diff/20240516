# Comparing `tmp/routput-0.9978.tar.gz` & `tmp/routput-0.9979.tar.gz`
...
## Comparing `routput-0.9978.tar` & `routput-0.9979.tar`
...
### Comparing `routput-0.9978/LICENCE` & `routput-0.9979/LICENCE`

 * *Files identical despite different names*

### Comparing `routput-0.9978/PKG-INFO` & `routput-0.9979/PKG-INFO`
...
### Comparing `routput-0.9978/README.md` & `routput-0.9979/README.md`

 * *Files identical despite different names*

### Comparing `routput-0.9978/README.py` & `routput-0.9979/README.py`

 * *Files identical despite different names*

### Comparing `routput-0.9978/pickled.py` & `routput-0.9979/pickled.py`
...
### Comparing `routput-0.9978/routput.egg-info/PKG-INFO` & `routput-0.9979/routput.egg-info/PKG-INFO`
...
### Comparing `routput-0.9978/templated_setup.py` & `routput-0.9979/templated_setup.py`
