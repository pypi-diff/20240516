# Comparing `tmp/routput-0.9986.tar.gz` & `tmp/routput-0.9987.tar.gz`
...
## Comparing `routput-0.9986.tar` & `routput-0.9987.tar`
...
### Comparing `routput-0.9986/LICENCE` & `routput-0.9987/LICENCE`

 * *Files identical despite different names*

### Comparing `routput-0.9986/PKG-INFO` & `routput-0.9987/PKG-INFO`
...
-## V0.9986 released on 16th/5/2024
+## V0.9987 released on 16th/5/2024
 hopefully `templated_setup` works now...
```

### Comparing `routput-0.9986/README.md` & `routput-0.9987/README.md`

 * *Files identical despite different names*

### Comparing `routput-0.9986/_README.py` & `routput-0.9987/_README.py`

 * *Files identical despite different names*

### Comparing `routput-0.9986/_pickled.py` & `routput-0.9987/_pickled.py`

 * *Files 1% similar despite different names*

```diff
@@ -1 +1 @@
-__INST__ = """"""
...
### Comparing `routput-0.9986/routput.egg-info/PKG-INFO` & `routput-0.9987/routput.egg-info/PKG-INFO`
...
### Comparing `routput-0.9986/templated_setup.py` & `routput-0.9987/templated_setup.py`
