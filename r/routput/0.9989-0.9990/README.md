# Comparing `tmp/routput-0.9989.tar.gz` & `tmp/routput-0.9990.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "routput-0.9989.tar", last modified: Thu May 16 13:45:07 2024, max compression
+gzip compressed data, was "routput-0.9990.tar", last modified: Thu May 16 13:50:14 2024, max compression
```

## Comparing `routput-0.9989.tar` & `routput-0.9990.tar`

### file list

```diff
@@ -1,14 +1,14 @@
-drwxrwxrwx   0        0        0        0 2024-05-16 13:45:07.186760 routput-0.9989/
--rw-rw-rw-   0        0        0    25652 2024-04-18 08:26:04.000000 routput-0.9989/LICENCE
--rw-rw-rw-   0        0        0     2597 2024-05-16 13:45:07.185740 routput-0.9989/PKG-INFO
--rw-rw-rw-   0        0        0     2083 2024-04-18 09:01:17.000000 routput-0.9989/README.md
--rw-rw-rw-   0        0        0     2687 2024-05-16 13:45:07.000000 routput-0.9989/_README.py
--rw-rw-rw-   0        0        0     3509 2024-05-16 13:45:07.000000 routput-0.9989/_pickled.py
-drwxrwxrwx   0        0        0        0 2024-05-16 13:45:07.184702 routput-0.9989/routput.egg-info/
--rw-rw-rw-   0        0        0     2597 2024-05-16 13:45:07.000000 routput-0.9989/routput.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      192 2024-05-16 13:45:07.000000 routput-0.9989/routput.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2024-05-16 13:45:07.000000 routput-0.9989/routput.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       41 2024-05-16 13:45:07.000000 routput-0.9989/routput.egg-info/top_level.txt
--rw-rw-rw-   0        0        0       42 2024-05-16 13:45:07.186760 routput-0.9989/setup.cfg
--rw-rw-rw-   0        0        0      498 2024-05-16 13:37:26.000000 routput-0.9989/setup.py
--rw-rw-rw-   0        0        0    21279 2024-05-16 13:45:07.000000 routput-0.9989/templated_setup.py
...
### Comparing `routput-0.9989/LICENCE` & `routput-0.9990/LICENCE`

 * *Files identical despite different names*

### Comparing `routput-0.9989/PKG-INFO` & `routput-0.9990/PKG-INFO`
...
-## V0.9989 released on 16th/5/2024
+## V0.9990 released on 16th/5/2024
 hopefully `templated_setup` works now...
```

### Comparing `routput-0.9989/README.md` & `routput-0.9990/README.md`

 * *Files identical despite different names*

### Comparing `routput-0.9989/_README.py` & `routput-0.9990/_README.py`

 * *Files identical despite different names*

### Comparing `routput-0.9989/_pickled.py` & `routput-0.9990/_pickled.py`

 * *Files 1% similar despite different names*

```diff
@@ -1 +1 @@
-__INST__ = """"""
...
### Comparing `routput-0.9989/routput.egg-info/PKG-INFO` & `routput-0.9990/routput.egg-info/PKG-INFO`
...
### Comparing `routput-0.9989/templated_setup.py` & `routput-0.9990/templated_setup.py`
