# Comparing `tmp/fintoolsap-1.7.5.tar.gz` & `tmp/fintoolsap-1.7.6.tar.gz`
...
### Comparing `fintoolsap-1.7.5/src/FinToolsAP/_config.py` & `fintoolsap-1.7.6/src/FinToolsAP/_config.py`
