# Comparing `tmp/fintoolsap-1.7.3.tar.gz` & `tmp/fintoolsap-1.7.4.tar.gz`
...
### Comparing `fintoolsap-1.7.3/src/FinToolsAP/PortfolioSorts.py` & `fintoolsap-1.7.4/src/FinToolsAP/PortfolioSorts.py`
