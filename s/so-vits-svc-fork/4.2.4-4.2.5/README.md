# Comparing `tmp/so_vits_svc_fork-4.2.4.tar.gz` & `tmp/so_vits_svc_fork-4.2.5.tar.gz`
...
### Comparing `so_vits_svc_fork-4.2.4/pyproject.toml` & `so_vits_svc_fork-4.2.5/pyproject.toml`
