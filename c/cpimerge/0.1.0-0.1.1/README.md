# Comparing `tmp/cpimerge-0.1.0.tar.gz` & `tmp/cpimerge-0.1.1.tar.gz`

## Comparing `cpimerge-0.1.0.tar` & `cpimerge-0.1.1.tar`
...
### Comparing `cpimerge-0.1.0/src/cpimerge/main.py` & `cpimerge-0.1.1/src/cpimerge/main.py`
...
### Comparing `cpimerge-0.1.0/.gitignore` & `cpimerge-0.1.1/.gitignore`

 * *Files identical despite different names*

### Comparing `cpimerge-0.1.0/LICENSE` & `cpimerge-0.1.1/LICENSE`

 * *Files identical despite different names*

### Comparing `cpimerge-0.1.0/pyproject.toml` & `cpimerge-0.1.1/pyproject.toml`
