# Comparing `tmp/django_restit-4.2.88.tar.gz` & `tmp/django_restit-4.2.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "django_restit-4.2.88.tar", max compression
+gzip compressed data, was "django_restit-4.2.9.tar", max compression
```

## Comparing `django_restit-4.2.88.tar` & `django_restit-4.2.9.tar`

### file list

```diff
@@ -1,512 +1,491 @@
--rw-r--r--   0        0        0     1068 2024-04-13 20:28:15.628821 django_restit-4.2.88/LICENSE.md
--rw-r--r--   0        0        0     6240 2024-04-13 20:28:15.628920 django_restit-4.2.88/README.md
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.629016 django_restit-4.2.88/account/__init__.py
--rw-r--r--   0        0        0     1839 2024-04-13 20:28:15.629085 django_restit-4.2.88/account/admin.py
--rw-r--r--   0        0        0      980 2024-04-13 20:28:15.629171 django_restit-4.2.88/account/fcm/__init__.py
--rw-r--r--   0        0        0     1710 2024-04-13 20:28:15.629233 django_restit-4.2.88/account/fcm/google.py
--rw-r--r--   0        0        0     1434 2024-04-13 20:28:15.629289 django_restit-4.2.88/account/fcm/v1.py
--rw-r--r--   0        0        0    15894 2024-04-13 20:28:15.629493 django_restit-4.2.88/account/migrations/0001_initial.py
--rw-r--r--   0        0        0      738 2024-04-13 20:28:15.629557 django_restit-4.2.88/account/migrations/0003_member_phone_number.py
--rw-r--r--   0        0        0      551 2024-04-13 20:28:15.629612 django_restit-4.2.88/account/migrations/0004_group_modified_alter_group_created.py
--rw-r--r--   0        0        0      437 2024-04-13 20:28:15.629669 django_restit-4.2.88/account/migrations/0005_member_auth_code_expires.py
--rw-r--r--   0        0        0      450 2024-04-13 20:28:15.629735 django_restit-4.2.88/account/migrations/0006_member_security_token.py
--rw-r--r--   0        0        0     1654 2024-04-13 20:28:15.629793 django_restit-4.2.88/account/migrations/0007_authtoken_signature_authsession.py
--rw-r--r--   0        0        0     2379 2024-04-13 20:28:15.629858 django_restit-4.2.88/account/migrations/0008_memberdevice_memberdevicemetadata.py
--rw-r--r--   0        0        0      468 2024-04-13 20:28:15.629909 django_restit-4.2.88/account/migrations/0009_alter_member_phone_number.py
--rw-r--r--   0        0        0      305 2024-04-13 20:28:15.629961 django_restit-4.2.88/account/migrations/0010_delete_authtoken.py
--rw-r--r--   0        0        0     1062 2024-04-13 20:28:15.630006 django_restit-4.2.88/account/migrations/0011_authtoken.py
--rw-r--r--   0        0        0     2043 2024-04-13 20:28:15.630059 django_restit-4.2.88/account/migrations/0012_settings_settingsmetadata.py
--rw-r--r--   0        0        0      418 2024-04-13 20:28:15.630114 django_restit-4.2.88/account/migrations/0013_memberdevice_ip.py
--rw-r--r--   0        0        0      541 2024-04-13 20:28:15.630162 django_restit-4.2.88/account/migrations/0014_alter_notificationmemberrecord_member.py
--rw-r--r--   0        0        0      460 2024-04-13 20:28:15.630211 django_restit-4.2.88/account/migrations/0015_memberdevice_buid.py
--rw-r--r--   0        0        0      424 2024-04-13 20:28:15.630262 django_restit-4.2.88/account/migrations/0016_authsession_buid.py
--rw-r--r--   0        0        0      375 2024-04-13 20:28:15.630324 django_restit-4.2.88/account/migrations/0017_rename_requires_topt_member_requires_totp.py
--rw-r--r--   0        0        0     1475 2024-04-13 20:28:15.630382 django_restit-4.2.88/account/migrations/0018_userpasskey.py
--rw-r--r--   0        0        0      601 2024-04-13 20:28:15.630452 django_restit-4.2.88/account/migrations/0019_group_location.py
--rw-r--r--   0        0        0     2250 2024-04-25 16:09:54.723585 django_restit-4.2.88/account/migrations/0020_cloudcredentials_cloudcredentialsmetadata.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.630482 django_restit-4.2.88/account/migrations/__init__.py
--rw-r--r--   0        0        0      385 2024-04-13 20:28:15.630615 django_restit-4.2.88/account/models/__init__.py
--rw-r--r--   0        0        0     5491 2024-05-03 22:34:25.131492 django_restit-4.2.88/account/models/device.py
--rw-r--r--   0        0        0     2011 2024-04-13 20:28:15.630794 django_restit-4.2.88/account/models/feeds.py
--rw-r--r--   0        0        0    22262 2024-05-16 16:56:19.272702 django_restit-4.2.88/account/models/group.py
--rw-r--r--   0        0        0     2720 2024-04-13 20:28:15.631007 django_restit-4.2.88/account/models/legacy.py
--rw-r--r--   0        0        0    53092 2024-05-14 19:14:54.930718 django_restit-4.2.88/account/models/member.py
--rw-r--r--   0        0        0     9249 2024-05-08 01:17:16.122005 django_restit-4.2.88/account/models/membership.py
--rw-r--r--   0        0        0    15306 2024-05-13 23:53:09.195555 django_restit-4.2.88/account/models/notify.py
--rw-r--r--   0        0        0     1516 2024-04-13 20:28:15.631615 django_restit-4.2.88/account/models/passkeys.py
--rw-r--r--   0        0        0     3737 2024-05-03 19:51:25.510322 django_restit-4.2.88/account/models/session.py
--rw-r--r--   0        0        0     2137 2024-04-13 20:28:15.631753 django_restit-4.2.88/account/models/settings.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.631821 django_restit-4.2.88/account/oauth/__init__.py
--rw-r--r--   0        0        0     2078 2024-04-13 20:28:15.631917 django_restit-4.2.88/account/oauth/google.py
--rw-r--r--   0        0        0       89 2024-04-13 20:28:15.632026 django_restit-4.2.88/account/passkeys/__init__.py
--rw-r--r--   0        0        0     4126 2024-04-25 16:09:54.725070 django_restit-4.2.88/account/passkeys/core.py
--rw-r--r--   0        0        0      874 2024-04-13 20:28:15.632196 django_restit-4.2.88/account/periodic.py
--rw-r--r--   0        0        0      336 2024-04-13 20:28:15.632316 django_restit-4.2.88/account/rpc/__init__.py
--rw-r--r--   0        0        0    16615 2024-05-11 18:22:59.362744 django_restit-4.2.88/account/rpc/auth.py
--rw-r--r--   0        0        0     3070 2024-05-03 21:17:34.200466 django_restit-4.2.88/account/rpc/device.py
--rw-r--r--   0        0        0     4230 2024-05-16 17:31:16.614278 django_restit-4.2.88/account/rpc/group.py
--rw-r--r--   0        0        0     1817 2024-05-11 00:18:44.008237 django_restit-4.2.88/account/rpc/member.py
--rw-r--r--   0        0        0     3344 2024-04-13 20:28:15.632714 django_restit-4.2.88/account/rpc/notify.py
--rw-r--r--   0        0        0     2864 2024-04-13 20:28:15.632792 django_restit-4.2.88/account/rpc/oauth.py
--rw-r--r--   0        0        0     1729 2024-04-13 20:28:15.632847 django_restit-4.2.88/account/rpc/passkeys.py
--rw-r--r--   0        0        0      271 2024-04-13 20:28:15.632903 django_restit-4.2.88/account/rpc/settings.py
--rw-r--r--   0        0        0       53 2024-04-13 20:28:15.632953 django_restit-4.2.88/account/settings.py
--rw-r--r--   0        0        0     9669 2024-05-10 19:31:50.813510 django_restit-4.2.88/account/templates/email/base.html
--rw-r--r--   0        0        0    10346 2024-05-10 19:30:56.128429 django_restit-4.2.88/account/templates/email/invite.html
--rw-r--r--   0        0        0    12600 2024-04-13 20:28:15.633509 django_restit-4.2.88/account/templates/email/plain/base.html
--rw-r--r--   0        0        0    14692 2024-05-10 21:14:10.951606 django_restit-4.2.88/account/templates/email/plain/invite.html
--rw-r--r--   0        0        0    13411 2024-05-10 21:08:49.022358 django_restit-4.2.88/account/templates/email/plain/reset_code.html
--rw-r--r--   0        0        0    10040 2024-05-10 21:09:00.248228 django_restit-4.2.88/account/templates/email/reset_code.html
--rw-r--r--   0        0        0    14604 2024-05-10 21:14:17.651731 django_restit-4.2.88/account/templates/email/simple/invite.html
--rw-r--r--   0        0        0    13401 2024-05-10 21:08:38.943379 django_restit-4.2.88/account/templates/email/simple/reset_code.html
--rw-r--r--   0        0        0    46361 2024-05-11 00:17:15.860611 django_restit-4.2.88/account/templates/unsubscribed.html
--rw-r--r--   0        0        0      520 2024-04-13 20:28:15.634310 django_restit-4.2.88/auditlog/README
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.634338 django_restit-4.2.88/auditlog/__init__.py
--rw-r--r--   0        0        0     1006 2024-04-13 20:28:15.634405 django_restit-4.2.88/auditlog/admin.py
--rw-r--r--   0        0        0     6788 2024-05-14 03:46:10.115535 django_restit-4.2.88/auditlog/cloudwatch.py
--rw-r--r--   0        0        0     6553 2024-04-13 20:28:15.634534 django_restit-4.2.88/auditlog/decorators.py
--rw-r--r--   0        0        0     1537 2024-04-13 20:28:15.634591 django_restit-4.2.88/auditlog/middleware.py
--rw-r--r--   0        0        0     3309 2024-04-13 20:28:15.634691 django_restit-4.2.88/auditlog/migrations/0001_initial.py
--rw-r--r--   0        0        0      541 2024-05-13 02:34:55.168831 django_restit-4.2.88/auditlog/migrations/0002_alter_persistentlog_session.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.634715 django_restit-4.2.88/auditlog/migrations/__init__.py
--rw-r--r--   0        0        0    16517 2024-04-13 20:28:15.634791 django_restit-4.2.88/auditlog/models.py
--rw-r--r--   0        0        0      363 2024-04-13 20:28:15.634866 django_restit-4.2.88/auditlog/periodic.py
--rw-r--r--   0        0        0     5592 2024-05-14 04:52:41.918784 django_restit-4.2.88/auditlog/rpc.py
--rw-r--r--   0        0        0     2415 2024-04-13 20:28:15.634967 django_restit-4.2.88/auditlog/tq.py
--rw-r--r--   0        0        0      163 2024-04-13 20:28:15.635019 django_restit-4.2.88/auditlog/urls.py
--rw-r--r--   0        0        0     2169 2024-04-13 20:28:15.636613 django_restit-4.2.88/inbox/README.md
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.636640 django_restit-4.2.88/inbox/__init__.py
--rw-r--r--   0        0        0      243 2024-04-13 20:28:15.636694 django_restit-4.2.88/inbox/admin.py
--rw-r--r--   0        0        0     5638 2024-04-13 20:28:15.636750 django_restit-4.2.88/inbox/handlers.py
--rw-r--r--   0        0        0     6429 2024-04-13 20:28:15.636826 django_restit-4.2.88/inbox/migrations/0001_initial.py
--rw-r--r--   0        0        0      380 2024-04-13 20:28:15.636873 django_restit-4.2.88/inbox/migrations/0002_alter_message_cc.py
--rw-r--r--   0        0        0      416 2024-04-13 20:28:15.636925 django_restit-4.2.88/inbox/migrations/0003_attachment_content_type.py
--rw-r--r--   0        0        0     1140 2024-04-13 20:28:15.636990 django_restit-4.2.88/inbox/migrations/0004_mailtemplate.py
--rw-r--r--   0        0        0      393 2024-05-13 02:34:55.167916 django_restit-4.2.88/inbox/migrations/0005_alter_mailbox_state.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.637014 django_restit-4.2.88/inbox/migrations/__init__.py
--rw-r--r--   0        0        0      174 2024-04-13 20:28:15.637210 django_restit-4.2.88/inbox/models/__init__.py
--rw-r--r--   0        0        0     2881 2024-04-13 20:28:15.637278 django_restit-4.2.88/inbox/models/bounce.py
--rw-r--r--   0        0        0     2517 2024-04-13 20:28:15.637330 django_restit-4.2.88/inbox/models/complaint.py
--rw-r--r--   0        0        0     3003 2024-04-13 20:28:15.637381 django_restit-4.2.88/inbox/models/message.py
--rw-r--r--   0        0        0     1013 2024-04-13 20:28:15.637431 django_restit-4.2.88/inbox/models/template.py
--rw-r--r--   0        0        0     1534 2024-04-13 20:28:15.637481 django_restit-4.2.88/inbox/rpc.py
--rw-r--r--   0        0        0       89 2024-04-13 20:28:15.637552 django_restit-4.2.88/inbox/utils/__init__.py
--rw-r--r--   0        0        0     4615 2024-04-13 20:28:15.637625 django_restit-4.2.88/inbox/utils/parsing.py
--rw-r--r--   0        0        0     4331 2024-05-10 19:44:35.001421 django_restit-4.2.88/inbox/utils/render.py
--rw-r--r--   0        0        0     2179 2024-04-13 20:28:15.637750 django_restit-4.2.88/inbox/utils/sending.py
--rw-r--r--   0        0        0     1114 2024-04-13 20:28:15.637830 django_restit-4.2.88/incident/README.md
--rw-r--r--   0        0        0     3455 2024-04-13 20:28:15.637889 django_restit-4.2.88/incident/__init__.py
--rw-r--r--   0        0        0     9720 2024-04-13 20:28:15.638179 django_restit-4.2.88/incident/migrations/0001_initial.py
--rw-r--r--   0        0        0      595 2024-04-13 20:28:15.638252 django_restit-4.2.88/incident/migrations/0002_event_component_event_component_id.py
--rw-r--r--   0        0        0      425 2024-04-13 20:28:15.638305 django_restit-4.2.88/incident/migrations/0003_rule_action.py
--rw-r--r--   0        0        0      662 2024-04-13 20:28:15.638359 django_restit-4.2.88/incident/migrations/0004_serverossecalert_ssh_sig_alter_rulecheck_parent.py
--rw-r--r--   0        0        0      698 2024-04-13 20:28:15.638414 django_restit-4.2.88/incident/migrations/0005_incident_component_alter_incident_state.py
--rw-r--r--   0        0        0      324 2024-04-13 20:28:15.638467 django_restit-4.2.88/incident/migrations/0006_delete_eventmetadata.py
--rw-r--r--   0        0        0      414 2024-04-13 20:28:15.638518 django_restit-4.2.88/incident/migrations/0007_event_metadata.py
--rw-r--r--   0        0        0      903 2024-04-13 20:28:15.638569 django_restit-4.2.88/incident/migrations/0008_incident_action_sent_incident_hostname_and_more.py
--rw-r--r--   0        0        0      473 2024-04-13 20:28:15.638617 django_restit-4.2.88/incident/migrations/0009_incident_reporter_ip.py
--rw-r--r--   0        0        0      631 2024-04-13 20:28:15.638665 django_restit-4.2.88/incident/migrations/0010_incident_category_incident_component_id.py
--rw-r--r--   0        0        0     2142 2024-04-13 20:28:15.638711 django_restit-4.2.88/incident/migrations/0011_ticket.py
--rw-r--r--   0        0        0      372 2024-04-13 20:28:15.638757 django_restit-4.2.88/incident/migrations/0012_rule_match_by.py
--rw-r--r--   0        0        0      387 2024-04-13 20:28:15.638814 django_restit-4.2.88/incident/migrations/0013_rulecheck_is_required.py
--rw-r--r--   0        0        0      724 2024-04-13 20:28:15.638862 django_restit-4.2.88/incident/migrations/0014_event_group_alter_rulecheck_index.py
--rw-r--r--   0        0        0      687 2024-05-13 02:35:36.839627 django_restit-4.2.88/incident/migrations/0015_rule_title_template_alter_incident_state.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.638883 django_restit-4.2.88/incident/migrations/__init__.py
--rw-r--r--   0        0        0      209 2024-04-13 20:28:15.638963 django_restit-4.2.88/incident/models/__init__.py
--rw-r--r--   0        0        0     7769 2024-05-13 02:54:01.165523 django_restit-4.2.88/incident/models/event.py
--rw-r--r--   0        0        0    19847 2024-05-16 18:20:47.273797 django_restit-4.2.88/incident/models/incident.py
--rw-r--r--   0        0        0     2252 2024-05-12 16:53:21.163497 django_restit-4.2.88/incident/models/ossec.py
--rw-r--r--   0        0        0     7001 2024-05-13 04:25:42.761665 django_restit-4.2.88/incident/models/rules.py
--rw-r--r--   0        0        0     2302 2024-04-13 20:28:15.639286 django_restit-4.2.88/incident/models/ticket.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.639341 django_restit-4.2.88/incident/parsers/__init__.py
--rw-r--r--   0        0        0    11609 2024-05-15 16:28:34.609597 django_restit-4.2.88/incident/parsers/ossec.py
--rw-r--r--   0        0        0      381 2024-04-13 20:28:15.639464 django_restit-4.2.88/incident/periodic.py
--rw-r--r--   0        0        0     8187 2024-05-14 15:21:12.014856 django_restit-4.2.88/incident/rpc.py
--rw-r--r--   0        0        0    13895 2024-05-10 19:31:58.659471 django_restit-4.2.88/incident/templates/email/incident_change.html
--rw-r--r--   0        0        0    13780 2024-05-10 19:32:01.508597 django_restit-4.2.88/incident/templates/email/incident_msg.html
--rw-r--r--   0        0        0    15185 2024-05-10 19:31:46.016828 django_restit-4.2.88/incident/templates/email/incident_new.html
--rw-r--r--   0        0        0    14739 2024-05-10 19:33:03.301598 django_restit-4.2.88/incident/templates/email/incident_plain.html
--rw-r--r--   0        0        0     5226 2024-04-13 20:28:15.640095 django_restit-4.2.88/incident/tq.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.640151 django_restit-4.2.88/location/__init__.py
--rw-r--r--   0        0        0      297 2024-04-13 20:28:15.640214 django_restit-4.2.88/location/admin.py
--rw-r--r--   0        0        0     1694 2024-04-13 20:28:15.640298 django_restit-4.2.88/location/geolocate.py
--rw-r--r--   0        0        0     7000 2024-04-13 20:28:15.640408 django_restit-4.2.88/location/migrations/0001_initial.py
--rw-r--r--   0        0        0      576 2024-04-13 20:28:15.640461 django_restit-4.2.88/location/migrations/0002_geoip_subnet_alter_geoip_ip.py
--rw-r--r--   0        0        0      443 2024-04-13 20:28:15.640514 django_restit-4.2.88/location/migrations/0003_address_postalcode_suffix.py
--rw-r--r--   0        0        0     1270 2024-04-13 20:28:15.640575 django_restit-4.2.88/location/migrations/0004_remove_address_modified_by_address_group_and_more.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.640602 django_restit-4.2.88/location/migrations/__init__.py
--rw-r--r--   0        0        0      230 2024-04-13 20:28:15.640694 django_restit-4.2.88/location/models/__init__.py
--rw-r--r--   0        0        0     3149 2024-04-13 20:28:15.640749 django_restit-4.2.88/location/models/address.py
--rw-r--r--   0        0        0     6039 2024-05-13 17:28:14.894161 django_restit-4.2.88/location/models/ip.py
--rw-r--r--   0        0        0     1994 2024-04-13 20:28:15.640866 django_restit-4.2.88/location/models/legacy.py
--rw-r--r--   0        0        0     2316 2024-04-13 20:28:15.640935 django_restit-4.2.88/location/models/location.py
--rw-r--r--   0        0        0     1474 2024-04-13 20:28:15.640986 django_restit-4.2.88/location/models/track.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.641044 django_restit-4.2.88/location/providers/__init__.py
--rw-r--r--   0        0        0      790 2024-05-13 17:27:03.924591 django_restit-4.2.88/location/providers/iplookup/__init__.py
--rw-r--r--   0        0        0     2419 2024-04-13 20:28:15.641198 django_restit-4.2.88/location/providers/iplookup/abstractapi.py
--rw-r--r--   0        0        0     1345 2024-04-13 20:28:15.641249 django_restit-4.2.88/location/providers/iplookup/extremeip.py
--rw-r--r--   0        0        0     2121 2024-04-13 20:28:15.641301 django_restit-4.2.88/location/providers/iplookup/geoplugin.py
--rw-r--r--   0        0        0     1797 2024-04-13 20:28:15.641374 django_restit-4.2.88/location/providers/iplookup/ipapi.py
--rw-r--r--   0        0        0     1265 2024-04-13 20:28:15.641436 django_restit-4.2.88/location/providers/iplookup/ipinfo.py
--rw-r--r--   0        0        0      937 2024-04-13 20:28:15.641497 django_restit-4.2.88/location/providers/iplookup/restit.py
--rw-r--r--   0        0        0       42 2024-04-13 20:28:15.641582 django_restit-4.2.88/location/providers/location/__init__.py
--rw-r--r--   0        0        0     2860 2024-04-13 20:28:15.641633 django_restit-4.2.88/location/providers/location/google.py
--rw-r--r--   0        0        0       46 2024-04-13 20:28:15.641713 django_restit-4.2.88/location/providers/timezones/__init__.py
--rw-r--r--   0        0        0      619 2024-04-13 20:28:15.641760 django_restit-4.2.88/location/providers/timezones/google.py
--rw-r--r--   0        0        0     1935 2024-04-13 20:28:15.641810 django_restit-4.2.88/location/providers/zillow.py
--rw-r--r--   0        0        0      166 2024-04-13 20:28:15.641885 django_restit-4.2.88/location/rpc/__init__.py
--rw-r--r--   0        0        0      219 2024-04-13 20:28:15.641939 django_restit-4.2.88/location/rpc/address.py
--rw-r--r--   0        0        0     1452 2024-05-15 01:10:30.262895 django_restit-4.2.88/location/rpc/ip.py
--rw-r--r--   0        0        0      779 2024-04-13 20:28:15.642041 django_restit-4.2.88/location/rpc/location.py
--rw-r--r--   0        0        0     3735 2024-04-13 20:28:15.642094 django_restit-4.2.88/location/rpc/track.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.642145 django_restit-4.2.88/medialib/__init__.py
--rw-r--r--   0        0        0     2261 2024-04-13 20:28:15.642205 django_restit-4.2.88/medialib/admin.py
--rw-r--r--   0        0        0       27 2024-04-13 20:28:15.642295 django_restit-4.2.88/medialib/cvutil/__init__.py
--rw-r--r--   0        0        0     4269 2024-04-13 20:28:15.642369 django_restit-4.2.88/medialib/cvutil/contours.py
--rw-r--r--   0        0        0    12649 2024-04-13 20:28:15.642503 django_restit-4.2.88/medialib/cvutil/images.py
--rw-r--r--   0        0        0     9586 2024-04-13 20:28:15.642653 django_restit-4.2.88/medialib/cvutil/misc.py
--rw-r--r--   0        0        0     5824 2024-04-13 20:28:15.642733 django_restit-4.2.88/medialib/cvutil/text.py
--rw-r--r--   0        0        0    48442 2024-04-13 20:28:15.642888 django_restit-4.2.88/medialib/fixtures/initial_data.json
--rw-r--r--   0        0        0    31978 2024-04-13 20:28:15.643014 django_restit-4.2.88/medialib/fixtures/medialib.json
--rw-r--r--   0        0        0    16989 2024-04-13 20:28:15.643144 django_restit-4.2.88/medialib/fixtures/medialib_test_fixture.json
--rw-r--r--   0        0        0     5442 2024-04-13 20:28:15.643241 django_restit-4.2.88/medialib/forms.py
--rw-r--r--   0        0        0    20518 2024-04-13 20:28:15.643376 django_restit-4.2.88/medialib/migrations/0001_initial.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.643436 django_restit-4.2.88/medialib/migrations/__init__.py
--rw-r--r--   0        0        0    52201 2024-05-15 22:58:30.568579 django_restit-4.2.88/medialib/models.py
--rw-r--r--   0        0        0     1189 2024-04-13 20:28:15.643657 django_restit-4.2.88/medialib/ocr.py
--rw-r--r--   0        0        0     1275 2024-04-13 20:28:15.643716 django_restit-4.2.88/medialib/pdf.py
--rw-r--r--   0        0        0      545 2024-04-13 20:28:15.643772 django_restit-4.2.88/medialib/qrcode.py
--rw-r--r--   0        0        0    10312 2024-04-13 20:28:15.643954 django_restit-4.2.88/medialib/render/__init__.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.644014 django_restit-4.2.88/medialib/render/engines/__init__.py
--rw-r--r--   0        0        0     3531 2024-04-13 20:28:15.644086 django_restit-4.2.88/medialib/render/engines/anigif.py
--rw-r--r--   0        0        0     6881 2024-04-13 20:28:15.644158 django_restit-4.2.88/medialib/render/engines/ffmpeg.py
--rw-r--r--   0        0        0      792 2024-04-13 20:28:15.644218 django_restit-4.2.88/medialib/render/engines/gifsicle.py
--rw-r--r--   0        0        0     3436 2024-04-13 20:28:15.644276 django_restit-4.2.88/medialib/render/engines/hls.py
--rw-r--r--   0        0        0      983 2024-04-13 20:28:15.644333 django_restit-4.2.88/medialib/render/engines/mp4box.py
--rw-r--r--   0        0        0      397 2024-04-13 20:28:15.644417 django_restit-4.2.88/medialib/render/engines/rtmp/Makefile
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.644448 django_restit-4.2.88/medialib/render/engines/rtmp/__init__.py
--rw-r--r--   0        0        0     4026 2024-04-13 20:28:15.644516 django_restit-4.2.88/medialib/render/engines/rtmp/rtmp.i
--rw-r--r--   0        0        0      699 2024-04-13 20:28:15.644579 django_restit-4.2.88/medialib/render/engines/rtmpdump.py
--rw-r--r--   0        0        0     1017 2024-04-13 20:28:15.644647 django_restit-4.2.88/medialib/render/engines/rtmpsink.py
--rw-r--r--   0        0        0     3466 2024-04-13 20:28:15.644704 django_restit-4.2.88/medialib/render/engines/video_getinfo.py
--rw-r--r--   0        0        0      809 2024-04-13 20:28:15.644758 django_restit-4.2.88/medialib/render/engines/websnap.py
--rw-r--r--   0        0        0     2193 2024-04-13 20:28:15.644812 django_restit-4.2.88/medialib/render/exceptions.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.644870 django_restit-4.2.88/medialib/render/presets/__init__.py
--rw-r--r--   0        0        0     4179 2024-04-13 20:28:15.644935 django_restit-4.2.88/medialib/render/presets/akamai.py
--rw-r--r--   0        0        0     3284 2024-04-13 20:28:15.644999 django_restit-4.2.88/medialib/render/presets/animated_thumbnail.py
--rw-r--r--   0        0        0     4004 2024-04-13 20:28:15.645068 django_restit-4.2.88/medialib/render/presets/ffmpeg.py
--rw-r--r--   0        0        0     2087 2024-04-13 20:28:15.645127 django_restit-4.2.88/medialib/render/presets/flv.py
--rw-r--r--   0        0        0     6567 2024-04-13 20:28:15.645209 django_restit-4.2.88/medialib/render/presets/hls.py
--rw-r--r--   0        0        0     6955 2024-04-13 20:28:15.645283 django_restit-4.2.88/medialib/render/presets/image_transcode.py
--rw-r--r--   0        0        0     1094 2024-04-13 20:28:15.645345 django_restit-4.2.88/medialib/render/presets/image_validate.py
--rw-r--r--   0        0        0     2423 2024-04-13 20:28:15.645404 django_restit-4.2.88/medialib/render/presets/mp4.py
--rw-r--r--   0        0        0     4997 2024-04-13 20:28:15.645468 django_restit-4.2.88/medialib/render/presets/video_still.py
--rw-r--r--   0        0        0     3228 2024-04-13 20:28:15.645531 django_restit-4.2.88/medialib/render/presets/video_validate.py
--rw-r--r--   0        0        0      863 2024-04-13 20:28:15.645582 django_restit-4.2.88/medialib/render/presets/websnap.py
--rw-r--r--   0        0        0     2282 2024-04-13 20:28:15.645637 django_restit-4.2.88/medialib/render/presets/youtube.py
--rw-r--r--   0        0        0    16451 2024-04-13 20:28:15.645717 django_restit-4.2.88/medialib/render/render_utils.py
--rw-r--r--   0        0        0      370 2024-04-13 20:28:15.645800 django_restit-4.2.88/medialib/render/schedule.py
--rw-r--r--   0        0        0       82 2024-04-13 20:28:15.645892 django_restit-4.2.88/medialib/rpc/__init__.py
--rw-r--r--   0        0        0    37925 2024-04-13 20:28:15.645993 django_restit-4.2.88/medialib/rpc/legacy.py
--rw-r--r--   0        0        0      617 2024-04-13 20:28:15.646082 django_restit-4.2.88/medialib/rpc/media.py
--rw-r--r--   0        0        0      956 2024-04-13 20:28:15.646147 django_restit-4.2.88/medialib/rpc/tools.py
--rwxr-xr-x   0        0        0     7875 2024-04-13 20:28:15.646262 django_restit-4.2.88/medialib/scripts/init_config
--rw-r--r--   0        0        0     4499 2024-04-13 20:28:15.646422 django_restit-4.2.88/medialib/static/css/base_medialibui.css
--rw-r--r--   0        0        0     3128 2024-04-13 20:28:15.646484 django_restit-4.2.88/medialib/static/css/base_widgets.css
--rw-r--r--   0        0        0     3263 2024-04-13 20:28:15.646541 django_restit-4.2.88/medialib/static/css/jquery.jcrop.css
--rw-r--r--   0        0        0      193 2024-04-13 20:28:15.646618 django_restit-4.2.88/medialib/static/img/arrow-down-white.png
--rw-r--r--   0        0        0     4589 2024-04-13 20:28:15.646683 django_restit-4.2.88/medialib/static/img/bg-body.gif
--rw-r--r--   0        0        0      441 2024-04-13 20:28:15.646733 django_restit-4.2.88/medialib/static/img/cancel.gif
--rw-r--r--   0        0        0      341 2024-04-13 20:28:15.646785 django_restit-4.2.88/medialib/static/img/icon-generic.gif
--rw-r--r--   0        0        0      355 2024-04-13 20:28:15.646841 django_restit-4.2.88/medialib/static/img/icon-image.gif
--rw-r--r--   0        0        0      359 2024-04-13 20:28:15.646891 django_restit-4.2.88/medialib/static/img/icon-media.gif
--rw-r--r--   0        0        0      355 2024-04-13 20:28:15.646947 django_restit-4.2.88/medialib/static/img/icon-zip.gif
--rw-r--r--   0        0        0     3208 2024-04-13 20:28:15.647004 django_restit-4.2.88/medialib/static/img/loading.gif
--rw-r--r--   0        0        0     2537 2024-04-13 20:28:15.647047 django_restit-4.2.88/medialib/static/img/noimage.gif
--rw-r--r--   0        0        0     1057 2024-04-13 20:28:15.647097 django_restit-4.2.88/medialib/static/img/render_err.gif
--rw-r--r--   0        0        0     6716 2024-04-13 20:28:15.647168 django_restit-4.2.88/medialib/static/img/rendering.gif
--rw-r--r--   0        0        0      292 2024-04-13 20:28:15.647217 django_restit-4.2.88/medialib/static/img/star_off.png
--rw-r--r--   0        0        0      297 2024-04-13 20:28:15.647266 django_restit-4.2.88/medialib/static/img/star_on.png
--rw-r--r--   0        0        0     1130 2024-04-13 20:28:15.647317 django_restit-4.2.88/medialib/static/img/unknown.gif
--rwxr-xr-x   0        0        0    74054 2024-04-13 20:28:15.647497 django_restit-4.2.88/medialib/static/lib/caman.full.js
--rw-r--r--   0        0        0    17360 2024-04-13 20:28:15.647608 django_restit-4.2.88/medialib/static/lib/hammer.min.js
--rwxr-xr-x   0        0        0    42434 2024-04-13 20:28:15.647726 django_restit-4.2.88/medialib/static/lib/jquery.Jcrop.js
--rw-r--r--   0        0        0      743 2024-04-13 20:28:15.647801 django_restit-4.2.88/medialib/static/lib/jquery.hammer.js
--rw-r--r--   0        0        0    16587 2024-04-13 20:28:15.647890 django_restit-4.2.88/medialib/static/lib/load-image.min.js
--rwxr-xr-x   0        0        0   111779 2024-04-13 20:28:15.648085 django_restit-4.2.88/medialib/static/lib/swiper.js
--rw-r--r--   0        0        0     1163 2024-04-13 20:28:15.648292 django_restit-4.2.88/medialib/static/lib/tinymce/plugins/medialib/editor_plugin.js
--rw-r--r--   0        0        0     1163 2024-04-13 20:28:15.648356 django_restit-4.2.88/medialib/static/lib/tinymce/plugins/medialib/editor_plugin_src.js
--rw-r--r--   0        0        0     5708 2024-04-13 20:28:15.648462 django_restit-4.2.88/medialib/static/lib/tinymce/plugins/medialib/js/dialog.js
--rw-r--r--   0        0        0     3502 2024-04-13 20:28:15.648520 django_restit-4.2.88/medialib/static/lib/tinymce/plugins/medialib/medialib.html
--rw-r--r--   0        0        0     5876 2024-04-13 20:28:15.648620 django_restit-4.2.88/medialib/stores/__init__.py
--rw-r--r--   0        0        0      601 2024-04-13 20:28:15.648728 django_restit-4.2.88/medialib/stores/apiclient/__init__.py
--rw-r--r--   0        0        0     9852 2024-04-13 20:28:15.648872 django_restit-4.2.88/medialib/stores/apiclient/channel.py
--rw-r--r--   0        0        0    35929 2024-04-13 20:28:15.648982 django_restit-4.2.88/medialib/stores/apiclient/discovery.py
--rw-r--r--   0        0        0     3516 2024-04-13 20:28:15.649082 django_restit-4.2.88/medialib/stores/apiclient/errors.py
--rw-r--r--   0        0        0    52911 2024-04-13 20:28:15.649208 django_restit-4.2.88/medialib/stores/apiclient/http.py
--rw-r--r--   0        0        0     6505 2024-04-13 20:28:15.649279 django_restit-4.2.88/medialib/stores/apiclient/mimeparse.py
--rw-r--r--   0        0        0    11761 2024-04-13 20:28:15.649414 django_restit-4.2.88/medialib/stores/apiclient/model.py
--rw-r--r--   0        0        0     3528 2024-04-13 20:28:15.649474 django_restit-4.2.88/medialib/stores/apiclient/sample_tools.py
--rw-r--r--   0        0        0     9293 2024-04-13 20:28:15.649619 django_restit-4.2.88/medialib/stores/apiclient/schema.py
--rw-r--r--   0        0        0     1592 2024-04-13 20:28:15.649685 django_restit-4.2.88/medialib/stores/filestore.py
--rw-r--r--   0        0        0    69575 2024-04-13 20:28:15.649881 django_restit-4.2.88/medialib/stores/httplib2/__init__.py
--rw-r--r--   0        0        0    39670 2024-04-13 20:28:15.650027 django_restit-4.2.88/medialib/stores/httplib2/cacerts.txt
--rw-r--r--   0        0        0     3821 2024-04-13 20:28:15.650118 django_restit-4.2.88/medialib/stores/httplib2/iri2uri.py
--rw-r--r--   0        0        0    18452 2024-04-13 20:28:15.650205 django_restit-4.2.88/medialib/stores/httplib2/socks.py
--rw-r--r--   0        0        0      706 2024-04-13 20:28:15.650292 django_restit-4.2.88/medialib/stores/httpstore.py
--rw-r--r--   0        0        0      304 2024-04-13 20:28:15.650355 django_restit-4.2.88/medialib/stores/nullstore.py
--rw-r--r--   0        0        0      213 2024-04-13 20:28:15.650459 django_restit-4.2.88/medialib/stores/oauth2client/__init__.py
--rw-r--r--   0        0        0     1044 2024-04-13 20:28:15.650539 django_restit-4.2.88/medialib/stores/oauth2client/anyjson.py
--rw-r--r--   0        0        0    32534 2024-04-13 20:28:15.650636 django_restit-4.2.88/medialib/stores/oauth2client/appengine.py
--rw-r--r--   0        0        0    44346 2024-04-13 20:28:15.650760 django_restit-4.2.88/medialib/stores/oauth2client/client.py
--rw-r--r--   0        0        0     4425 2024-04-13 20:28:15.650827 django_restit-4.2.88/medialib/stores/oauth2client/clientsecrets.py
--rw-r--r--   0        0        0    10239 2024-04-13 20:28:15.650953 django_restit-4.2.88/medialib/stores/oauth2client/crypt.py
--rw-r--r--   0        0        0     3755 2024-04-13 20:28:15.651011 django_restit-4.2.88/medialib/stores/oauth2client/django_orm.py
--rw-r--r--   0        0        0     3164 2024-04-13 20:28:15.651090 django_restit-4.2.88/medialib/stores/oauth2client/file.py
--rw-r--r--   0        0        0     3036 2024-04-13 20:28:15.651142 django_restit-4.2.88/medialib/stores/oauth2client/gce.py
--rw-r--r--   0        0        0     3229 2024-04-13 20:28:15.651203 django_restit-4.2.88/medialib/stores/oauth2client/keyring_storage.py
--rw-r--r--   0        0        0    11393 2024-04-13 20:28:15.651337 django_restit-4.2.88/medialib/stores/oauth2client/locked_file.py
--rw-r--r--   0        0        0    13950 2024-04-13 20:28:15.651445 django_restit-4.2.88/medialib/stores/oauth2client/multistore_file.py
--rw-r--r--   0        0        0     5588 2024-04-13 20:28:15.651500 django_restit-4.2.88/medialib/stores/oauth2client/old_run.py
--rw-r--r--   0        0        0     8379 2024-04-13 20:28:15.651633 django_restit-4.2.88/medialib/stores/oauth2client/tools.py
--rw-r--r--   0        0        0     5706 2024-04-13 20:28:15.651698 django_restit-4.2.88/medialib/stores/oauth2client/util.py
--rw-r--r--   0        0        0     3367 2024-04-13 20:28:15.651754 django_restit-4.2.88/medialib/stores/oauth2client/xsrfutil.py
--rw-r--r--   0        0        0      500 2024-04-13 20:28:15.651802 django_restit-4.2.88/medialib/stores/rtmpstore.py
--rw-r--r--   0        0        0     4583 2024-04-13 20:28:15.651859 django_restit-4.2.88/medialib/stores/s3store.py
--rw-r--r--   0        0        0     4996 2024-04-13 20:28:15.651952 django_restit-4.2.88/medialib/stores/uritemplate/__init__.py
--rw-r--r--   0        0        0      406 2024-04-13 20:28:15.652008 django_restit-4.2.88/medialib/stores/youtubestore.py
--rw-r--r--   0        0        0     3691 2024-04-13 20:28:15.652134 django_restit-4.2.88/medialib/templates/medialib/base.html
--rw-r--r--   0        0        0     1277 2024-04-13 20:28:15.652198 django_restit-4.2.88/medialib/templates/medialib/instances.html
--rw-r--r--   0        0        0     1170 2024-04-13 20:28:15.652246 django_restit-4.2.88/medialib/templates/medialib/items.html
--rw-r--r--   0        0        0     8194 2024-04-13 20:28:15.652381 django_restit-4.2.88/medialib/templates/medialib/library.html
--rw-r--r--   0        0        0       65 2024-04-13 20:28:15.652434 django_restit-4.2.88/medialib/templates/medialib/notify_error.subject
--rw-r--r--   0        0        0       49 2024-04-13 20:28:15.652482 django_restit-4.2.88/medialib/templates/medialib/notify_error.to
--rw-r--r--   0        0        0      272 2024-04-13 20:28:15.652541 django_restit-4.2.88/medialib/templates/medialib/notify_error.txt
--rw-r--r--   0        0        0       71 2024-04-13 20:28:15.652606 django_restit-4.2.88/medialib/templates/medialib/notify_ready.subject
--rw-r--r--   0        0        0       49 2024-04-13 20:28:15.652663 django_restit-4.2.88/medialib/templates/medialib/notify_ready.to
--rw-r--r--   0        0        0      298 2024-04-13 20:28:15.652727 django_restit-4.2.88/medialib/templates/medialib/notify_ready.txt
--rw-r--r--   0        0        0       64 2024-04-13 20:28:15.652785 django_restit-4.2.88/medialib/templates/medialib/notify_render_error.subject
--rw-r--r--   0        0        0       48 2024-04-13 20:28:15.652835 django_restit-4.2.88/medialib/templates/medialib/notify_render_error.to
--rw-r--r--   0        0        0      271 2024-04-13 20:28:15.652886 django_restit-4.2.88/medialib/templates/medialib/notify_render_error.txt
--rw-r--r--   0        0        0       68 2024-04-13 20:28:15.652934 django_restit-4.2.88/medialib/templates/medialib/notify_validate_error.subject
--rw-r--r--   0        0        0       48 2024-04-13 20:28:15.652984 django_restit-4.2.88/medialib/templates/medialib/notify_validate_error.to
--rw-r--r--   0        0        0      275 2024-04-13 20:28:15.653031 django_restit-4.2.88/medialib/templates/medialib/notify_validate_error.txt
--rw-r--r--   0        0        0      206 2024-04-13 20:28:15.653082 django_restit-4.2.88/medialib/templates/medialib/smil
--rw-r--r--   0        0        0     1177 2024-04-13 20:28:15.653133 django_restit-4.2.88/medialib/templates/medialib/test.html
--rw-r--r--   0        0        0     1549 2024-04-13 20:28:15.653202 django_restit-4.2.88/medialib/templates/medialib/testpicker.html
--rw-r--r--   0        0        0     6045 2024-04-13 20:28:15.653257 django_restit-4.2.88/medialib/tests.py
--rw-r--r--   0        0        0      544 2024-04-13 20:28:15.653311 django_restit-4.2.88/medialib/tq.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.653335 django_restit-4.2.88/medialib/urls.py
--rw-r--r--   0        0        0     3756 2024-04-13 20:28:15.653405 django_restit-4.2.88/medialib/utils.py
--rw-r--r--   0        0        0     4321 2024-04-13 20:28:15.653460 django_restit-4.2.88/medialib/views.py
--rw-r--r--   0        0        0     4303 2024-04-13 20:28:15.653559 django_restit-4.2.88/medialib/youtube/__init__.py
--rw-r--r--   0        0        0      601 2024-04-13 20:28:15.653649 django_restit-4.2.88/medialib/youtube/apiclient/__init__.py
--rw-r--r--   0        0        0     9886 2024-04-13 20:28:15.653775 django_restit-4.2.88/medialib/youtube/apiclient/channel.py
--rw-r--r--   0        0        0    35907 2024-04-13 20:28:15.653881 django_restit-4.2.88/medialib/youtube/apiclient/discovery.py
--rw-r--r--   0        0        0     3550 2024-04-13 20:28:15.653946 django_restit-4.2.88/medialib/youtube/apiclient/errors.py
--rw-r--r--   0        0        0    52945 2024-04-13 20:28:15.654022 django_restit-4.2.88/medialib/youtube/apiclient/http.py
--rw-r--r--   0        0        0     6505 2024-04-13 20:28:15.654098 django_restit-4.2.88/medialib/youtube/apiclient/mimeparse.py
--rw-r--r--   0        0        0    11795 2024-04-13 20:28:15.654220 django_restit-4.2.88/medialib/youtube/apiclient/model.py
--rw-r--r--   0        0        0     3596 2024-04-13 20:28:15.654275 django_restit-4.2.88/medialib/youtube/apiclient/sample_tools.py
--rw-r--r--   0        0        0     9327 2024-04-13 20:28:15.654397 django_restit-4.2.88/medialib/youtube/apiclient/schema.py
--rw-r--r--   0        0        0    69581 2024-04-13 20:28:15.654522 django_restit-4.2.88/medialib/youtube/httplib2/__init__.py
--rw-r--r--   0        0        0    39670 2024-04-13 20:28:15.654649 django_restit-4.2.88/medialib/youtube/httplib2/cacerts.txt
--rw-r--r--   0        0        0     3821 2024-04-13 20:28:15.654713 django_restit-4.2.88/medialib/youtube/httplib2/iri2uri.py
--rw-r--r--   0        0        0    18452 2024-04-13 20:28:15.654782 django_restit-4.2.88/medialib/youtube/httplib2/socks.py
--rw-r--r--   0        0        0      213 2024-04-13 20:28:15.654878 django_restit-4.2.88/medialib/youtube/oauth2client/__init__.py
--rw-r--r--   0        0        0     1044 2024-04-13 20:28:15.654931 django_restit-4.2.88/medialib/youtube/oauth2client/anyjson.py
--rw-r--r--   0        0        0    32534 2024-04-13 20:28:15.655013 django_restit-4.2.88/medialib/youtube/oauth2client/appengine.py
--rw-r--r--   0        0        0    44431 2024-04-13 20:28:15.655081 django_restit-4.2.88/medialib/youtube/oauth2client/client.py
--rw-r--r--   0        0        0     4425 2024-04-13 20:28:15.655147 django_restit-4.2.88/medialib/youtube/oauth2client/clientsecrets.py
--rw-r--r--   0        0        0    10239 2024-04-13 20:28:15.655276 django_restit-4.2.88/medialib/youtube/oauth2client/crypt.py
--rw-r--r--   0        0        0     3753 2024-04-13 20:28:15.655327 django_restit-4.2.88/medialib/youtube/oauth2client/django_orm.py
--rw-r--r--   0        0        0     3164 2024-04-13 20:28:15.655376 django_restit-4.2.88/medialib/youtube/oauth2client/file.py
--rw-r--r--   0        0        0     3036 2024-04-13 20:28:15.655423 django_restit-4.2.88/medialib/youtube/oauth2client/gce.py
--rw-r--r--   0        0        0     3229 2024-04-13 20:28:15.655475 django_restit-4.2.88/medialib/youtube/oauth2client/keyring_storage.py
--rw-r--r--   0        0        0    11393 2024-04-13 20:28:15.655598 django_restit-4.2.88/medialib/youtube/oauth2client/locked_file.py
--rw-r--r--   0        0        0    13950 2024-04-13 20:28:15.655705 django_restit-4.2.88/medialib/youtube/oauth2client/multistore_file.py
--rw-r--r--   0        0        0     5588 2024-04-13 20:28:15.655760 django_restit-4.2.88/medialib/youtube/oauth2client/old_run.py
--rw-r--r--   0        0        0     8379 2024-04-13 20:28:15.655892 django_restit-4.2.88/medialib/youtube/oauth2client/tools.py
--rw-r--r--   0        0        0     5706 2024-04-13 20:28:15.655944 django_restit-4.2.88/medialib/youtube/oauth2client/util.py
--rw-r--r--   0        0        0     3367 2024-04-13 20:28:15.655994 django_restit-4.2.88/medialib/youtube/oauth2client/xsrfutil.py
--rw-r--r--   0        0        0     2849 2024-04-13 20:28:15.656049 django_restit-4.2.88/medialib/youtube/upload.py
--rw-r--r--   0        0        0     4996 2024-04-13 20:28:15.656132 django_restit-4.2.88/medialib/youtube/uritemplate/__init__.py
--rw-r--r--   0        0        0     2307 2024-04-13 20:28:15.656213 django_restit-4.2.88/metrics/README.md
--rw-r--r--   0        0        0       90 2024-04-13 20:28:15.656260 django_restit-4.2.88/metrics/__init__.py
--rw-r--r--   0        0        0    25251 2024-05-15 03:10:33.369045 django_restit-4.2.88/metrics/client.py
--rw-r--r--   0        0        0     9182 2024-04-13 20:28:15.656504 django_restit-4.2.88/metrics/eod.py
--rw-r--r--   0        0        0     1664 2024-04-13 20:28:15.656581 django_restit-4.2.88/metrics/examples/eod_example.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.656631 django_restit-4.2.88/metrics/management/__init__.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.656688 django_restit-4.2.88/metrics/management/commands/__init__.py
--rw-r--r--   0        0        0      429 2024-04-13 20:28:15.656742 django_restit-4.2.88/metrics/management/commands/delete_gauge.py
--rw-r--r--   0        0        0      464 2024-04-13 20:28:15.656786 django_restit-4.2.88/metrics/management/commands/delete_metric.py
--rw-r--r--   0        0        0     2801 2024-04-13 20:28:15.656837 django_restit-4.2.88/metrics/management/commands/fix_redis_metrics_keys.py
--rw-r--r--   0        0        0     1928 2024-04-13 20:28:15.656890 django_restit-4.2.88/metrics/management/commands/generate_test_metrics.py
--rw-r--r--   0        0        0     1742 2024-04-13 20:28:15.656939 django_restit-4.2.88/metrics/management/commands/redis_metrics_send_mail.py
--rw-r--r--   0        0        0     1874 2024-04-13 20:28:15.656985 django_restit-4.2.88/metrics/management/commands/reset_weekly_metrics.py
--rw-r--r--   0        0        0     4343 2024-04-13 20:28:15.657038 django_restit-4.2.88/metrics/management/commands/system_metric.py
--rw-r--r--   0        0        0     2399 2024-04-13 20:28:15.657120 django_restit-4.2.88/metrics/migrations/0001_initial.py
--rw-r--r--   0        0        0     1510 2024-04-13 20:28:15.657174 django_restit-4.2.88/metrics/migrations/0002_metrics_k11_metrics_k12_metrics_k13_metrics_k14_and_more.py
--rw-r--r--   0        0        0      453 2024-04-13 20:28:15.657215 django_restit-4.2.88/metrics/migrations/0003_metrics_expires.py
--rw-r--r--   0        0        0     3271 2024-04-13 20:28:15.657266 django_restit-4.2.88/metrics/migrations/0004_eodmetrics.py
--rw-r--r--   0        0        0     2358 2024-04-13 20:28:15.657318 django_restit-4.2.88/metrics/migrations/0005_alter_metrics_v1_alter_metrics_v10_alter_metrics_v11_and_more.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.657341 django_restit-4.2.88/metrics/migrations/__init__.py
--rw-r--r--   0        0        0    13444 2024-04-13 20:28:15.657464 django_restit-4.2.88/metrics/models.py
--rw-r--r--   0        0        0      651 2024-04-13 20:28:15.657514 django_restit-4.2.88/metrics/periodic.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.657565 django_restit-4.2.88/metrics/providers/__init__.py
--rw-r--r--   0        0        0     7432 2024-04-13 20:28:15.657627 django_restit-4.2.88/metrics/providers/aws.py
--rw-r--r--   0        0        0    21300 2024-05-15 03:10:09.350305 django_restit-4.2.88/metrics/rpc.py
--rw-r--r--   0        0        0      132 2024-04-13 20:28:15.657771 django_restit-4.2.88/metrics/settings.py
--rw-r--r--   0        0        0      825 2024-05-08 16:38:17.204112 django_restit-4.2.88/metrics/tq.py
--rw-r--r--   0        0        0    12606 2024-05-15 02:58:12.813043 django_restit-4.2.88/metrics/utils.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.658051 django_restit-4.2.88/pushit/__init__.py
--rw-r--r--   0        0        0      451 2024-04-13 20:28:15.658105 django_restit-4.2.88/pushit/admin.py
--rw-r--r--   0        0        0     4555 2024-04-13 20:28:15.658188 django_restit-4.2.88/pushit/migrations/0001_initial.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.658208 django_restit-4.2.88/pushit/migrations/__init__.py
--rw-r--r--   0        0        0     5066 2024-04-13 20:28:15.658264 django_restit-4.2.88/pushit/models.py
--rw-r--r--   0        0        0       88 2024-04-13 20:28:15.658337 django_restit-4.2.88/pushit/rpc/__init__.py
--rw-r--r--   0        0        0     1756 2024-04-13 20:28:15.658394 django_restit-4.2.88/pushit/rpc/githooks.py
--rw-r--r--   0        0        0     5028 2024-04-13 20:28:15.658451 django_restit-4.2.88/pushit/rpc/legacy.py
--rw-r--r--   0        0        0      378 2024-04-13 20:28:15.658498 django_restit-4.2.88/pushit/rpc/products.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.658581 django_restit-4.2.88/pushit/static/js/models_pushit.js
--rw-r--r--   0        0        0      424 2024-04-13 20:28:15.658635 django_restit-4.2.88/pushit/tq.py
--rw-r--r--   0        0        0     2121 2024-04-13 20:28:15.658692 django_restit-4.2.88/pushit/utils.py
--rw-r--r--   0        0        0     1223 2024-05-16 18:30:46.704687 django_restit-4.2.88/pyproject.toml
--rw-r--r--   0        0        0      118 2024-04-13 20:28:15.658826 django_restit-4.2.88/rest/.gitignore
--rw-r--r--   0        0        0     5460 2024-04-13 20:28:15.658873 django_restit-4.2.88/rest/README.md
--rw-r--r--   0        0        0       72 2024-04-13 20:28:15.658918 django_restit-4.2.88/rest/RemoteEvents.py
--rw-r--r--   0        0        0      121 2024-04-25 16:09:54.726545 django_restit-4.2.88/rest/__init__.py
--rw-r--r--   0        0        0     1967 2024-04-13 20:28:15.659011 django_restit-4.2.88/rest/arc4.py
--rw-r--r--   0        0        0       83 2024-04-13 20:28:15.659054 django_restit-4.2.88/rest/cache.py
--rw-r--r--   0        0        0       72 2024-04-13 20:28:15.659122 django_restit-4.2.88/rest/crypto/__init__.py
--rw-r--r--   0        0        0     4372 2024-04-13 20:28:15.659176 django_restit-4.2.88/rest/crypto/aes.py
--rw-r--r--   0        0        0     4082 2024-04-13 20:28:15.659224 django_restit-4.2.88/rest/crypto/privpub.py
--rw-r--r--   0        0        0     4514 2024-04-13 20:28:15.659274 django_restit-4.2.88/rest/crypto/util.py
--rw-r--r--   0        0        0    12335 2024-05-14 01:14:52.490579 django_restit-4.2.88/rest/datem.py
--rw-r--r--   0        0        0    15082 2024-04-13 20:28:15.659521 django_restit-4.2.88/rest/decorators.py
--rw-r--r--   0        0        0      788 2024-04-13 20:28:15.659585 django_restit-4.2.88/rest/encryption.py
--rw-r--r--   0        0        0      612 2024-04-13 20:28:15.659638 django_restit-4.2.88/rest/errors.py
--rw-r--r--   0        0        0       54 2024-04-13 20:28:15.659709 django_restit-4.2.88/rest/extra/__init__.py
--rw-r--r--   0        0        0     1078 2024-04-13 20:28:15.659754 django_restit-4.2.88/rest/extra/json_metadata.py
--rw-r--r--   0        0        0     9719 2024-04-13 20:28:15.659880 django_restit-4.2.88/rest/fields.py
--rw-r--r--   0        0        0     6316 2024-04-13 20:28:15.659935 django_restit-4.2.88/rest/forms.py
--rw-r--r--   0        0        0    29450 2024-05-16 16:51:41.779758 django_restit-4.2.88/rest/helpers.py
--rw-r--r--   0        0        0      260 2024-04-13 20:28:15.660082 django_restit-4.2.88/rest/joke.py
--rw-r--r--   0        0        0     2444 2024-05-11 18:15:45.432169 django_restit-4.2.88/rest/jwtoken.py
--rw-r--r--   0        0        0    20930 2024-04-13 20:28:15.660211 django_restit-4.2.88/rest/log.py
--rw-r--r--   0        0        0     7965 2024-04-30 22:59:33.205817 django_restit-4.2.88/rest/mail.py
--rw-r--r--   0        0        0     9174 2024-04-13 20:28:15.660384 django_restit-4.2.88/rest/mailman.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.660446 django_restit-4.2.88/rest/management/__init__.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.660519 django_restit-4.2.88/rest/management/commands/__init__.py
--rw-r--r--   0        0        0      389 2024-04-13 20:28:15.660585 django_restit-4.2.88/rest/management/commands/rpc.py
--rw-r--r--   0        0        0       33 2024-04-13 20:28:15.660670 django_restit-4.2.88/rest/middleware/__init__.py
--rw-r--r--   0        0        0     3513 2024-04-13 20:28:15.660732 django_restit-4.2.88/rest/middleware/cors.py
--rw-r--r--   0        0        0     2345 2024-04-13 20:28:15.660813 django_restit-4.2.88/rest/middleware/db_router.py
--rw-r--r--   0        0        0     6017 2024-04-13 20:28:15.660879 django_restit-4.2.88/rest/middleware/jwt.py
--rw-r--r--   0        0        0     4189 2024-04-13 20:28:15.660938 django_restit-4.2.88/rest/middleware/request.py
--rw-r--r--   0        0        0    10240 2024-04-13 20:28:15.661058 django_restit-4.2.88/rest/middleware/session.py
--rw-r--r--   0        0        0     1901 2024-04-13 20:28:15.661107 django_restit-4.2.88/rest/middleware/session_store.py
--rw-r--r--   0        0        0      130 2024-04-13 20:28:15.661198 django_restit-4.2.88/rest/models/__init__.py
--rw-r--r--   0        0        0    69675 2024-05-12 22:38:49.331753 django_restit-4.2.88/rest/models/base.py
--rw-r--r--   0        0        0      578 2024-04-13 20:28:15.661399 django_restit-4.2.88/rest/models/cacher.py
--rw-r--r--   0        0        0    12860 2024-04-13 20:28:15.661509 django_restit-4.2.88/rest/models/metadata.py
--rw-r--r--   0        0        0     2974 2024-04-13 20:28:15.661574 django_restit-4.2.88/rest/net.py
--rw-r--r--   0        0        0   149463 2024-04-13 20:28:15.661780 django_restit-4.2.88/rest/regexes.yaml
--rw-r--r--   0        0        0    16127 2024-04-13 20:28:15.661904 django_restit-4.2.88/rest/requestex.py
--rw-r--r--   0        0        0     4200 2024-04-13 20:28:15.661966 django_restit-4.2.88/rest/rpc.py
--rw-r--r--   0        0        0     8362 2024-04-13 20:28:15.662107 django_restit-4.2.88/rest/search.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.662168 django_restit-4.2.88/rest/serializers/__init__.py
--rw-r--r--   0        0        0     4646 2024-04-13 20:28:15.662236 django_restit-4.2.88/rest/serializers/collection.py
--rw-r--r--   0        0        0     3916 2024-04-13 20:28:15.662294 django_restit-4.2.88/rest/serializers/csv.py
--rw-r--r--   0        0        0     1077 2024-04-13 20:28:15.662347 django_restit-4.2.88/rest/serializers/excel.py
--rw-r--r--   0        0        0     1736 2024-04-13 20:28:15.662397 django_restit-4.2.88/rest/serializers/json.py
--rw-r--r--   0        0        0    61981 2024-04-13 20:28:15.662517 django_restit-4.2.88/rest/serializers/legacy.py
--rw-r--r--   0        0        0      410 2024-04-13 20:28:15.662578 django_restit-4.2.88/rest/serializers/localizers.py
--rw-r--r--   0        0        0     8598 2024-04-13 20:28:15.662709 django_restit-4.2.88/rest/serializers/model.py
--rw-r--r--   0        0        0      997 2024-04-13 20:28:15.662760 django_restit-4.2.88/rest/serializers/profiler.py
--rw-r--r--   0        0        0     7602 2024-05-10 20:20:45.107027 django_restit-4.2.88/rest/serializers/response.py
--rw-r--r--   0        0        0     2734 2024-04-13 20:28:15.662937 django_restit-4.2.88/rest/serializers/util.py
--rw-r--r--   0        0        0     1532 2024-04-13 20:28:15.662997 django_restit-4.2.88/rest/settings_helper.py
--rw-r--r--   0        0        0     1419 2024-04-13 20:28:15.663054 django_restit-4.2.88/rest/ssl_check.py
--rw-r--r--   0        0        0    95786 2024-04-13 20:28:15.663327 django_restit-4.2.88/rest/static/lib/jquery.js
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.663392 django_restit-4.2.88/rest/static/rest/app.css
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.663422 django_restit-4.2.88/rest/static/rest/app.js
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.663450 django_restit-4.2.88/rest/static/rest/rest.js
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.663479 django_restit-4.2.88/rest/static/rest/rest.scss
--rw-r--r--   0        0        0      529 2024-04-13 20:28:15.663592 django_restit-4.2.88/rest/templates/email/error.html
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.663618 django_restit-4.2.88/rest/templates/email/error.subject
--rw-r--r--   0        0        0     7148 2024-04-13 20:28:15.663684 django_restit-4.2.88/rest/templates/rest_docs.html
--rw-r--r--   0        0        0    11048 2024-04-13 20:28:15.663811 django_restit-4.2.88/rest/templates/rest_html.html
--rw-r--r--   0        0        0   185398 2024-04-13 20:28:15.664071 django_restit-4.2.88/rest/ua.py
--rw-r--r--   0        0        0    17064 2024-04-13 20:28:15.664170 django_restit-4.2.88/rest/uberdict.py
--rw-r--r--   0        0        0    11881 2024-04-13 20:28:15.664320 django_restit-4.2.88/rest/url_docs.py
--rw-r--r--   0        0        0     1870 2024-04-30 22:59:33.197788 django_restit-4.2.88/rest/urls.py
--rw-r--r--   0        0        0     1115 2024-04-13 20:28:15.664431 django_restit-4.2.88/rest/views.py
--rw-r--r--   0        0        0      118 2024-04-13 20:28:15.664508 django_restit-4.2.88/sessionlog/.gitignore
--rw-r--r--   0        0        0       62 2024-04-13 20:28:15.664553 django_restit-4.2.88/sessionlog/README.md
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.664575 django_restit-4.2.88/sessionlog/__init__.py
--rw-r--r--   0        0        0      245 2024-04-13 20:28:15.664632 django_restit-4.2.88/sessionlog/admin.py
--rw-r--r--   0        0        0     1694 2024-04-13 20:28:15.664704 django_restit-4.2.88/sessionlog/migrations/0001_initial.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.664729 django_restit-4.2.88/sessionlog/migrations/__init__.py
--rw-r--r--   0        0        0     3662 2024-04-13 20:28:15.664797 django_restit-4.2.88/sessionlog/models.py
--rw-r--r--   0        0        0      383 2024-04-13 20:28:15.664849 django_restit-4.2.88/sessionlog/tests.py
--rw-r--r--   0        0        0       26 2024-04-13 20:28:15.664899 django_restit-4.2.88/sessionlog/views.py
--rw-r--r--   0        0        0     2196 2024-04-13 20:28:15.664987 django_restit-4.2.88/taskqueue/README.md
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.665015 django_restit-4.2.88/taskqueue/__init__.py
--rw-r--r--   0        0        0      208 2024-04-13 20:28:15.665073 django_restit-4.2.88/taskqueue/admin.py
--rw-r--r--   0        0        0     4738 2024-04-13 20:28:15.665172 django_restit-4.2.88/taskqueue/migrations/0001_initial.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.665197 django_restit-4.2.88/taskqueue/migrations/__init__.py
--rw-r--r--   0        0        0    22407 2024-04-13 20:28:15.665283 django_restit-4.2.88/taskqueue/models.py
--rw-r--r--   0        0        0     3543 2024-04-13 20:28:15.665348 django_restit-4.2.88/taskqueue/periodic.py
--rw-r--r--   0        0        0     5793 2024-05-11 15:22:18.077751 django_restit-4.2.88/taskqueue/rpc.py
--rw-r--r--   0        0        0      942 2024-04-13 20:28:15.665450 django_restit-4.2.88/taskqueue/tq.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.665504 django_restit-4.2.88/taskqueue/transports/__init__.py
--rw-r--r--   0        0        0      623 2024-04-13 20:28:15.665563 django_restit-4.2.88/taskqueue/transports/email.py
--rw-r--r--   0        0        0      839 2024-04-13 20:28:15.665619 django_restit-4.2.88/taskqueue/transports/http.py
--rw-r--r--   0        0        0     1913 2024-04-13 20:28:15.665676 django_restit-4.2.88/taskqueue/transports/s3.py
--rw-r--r--   0        0        0     1891 2024-04-13 20:28:15.665722 django_restit-4.2.88/taskqueue/transports/sftp.py
--rw-r--r--   0        0        0      142 2024-04-13 20:28:15.665764 django_restit-4.2.88/taskqueue/transports/sms.py
--rw-r--r--   0        0        0    15822 2024-04-13 20:28:15.665889 django_restit-4.2.88/taskqueue/worker.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.665935 django_restit-4.2.88/telephony/__init__.py
--rw-r--r--   0        0        0      243 2024-04-13 20:28:15.665979 django_restit-4.2.88/telephony/admin.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.665998 django_restit-4.2.88/telephony/decorators.py
--rw-r--r--   0        0        0     3030 2024-04-13 20:28:15.666076 django_restit-4.2.88/telephony/migrations/0001_initial.py
--rw-r--r--   0        0        0      424 2024-04-13 20:28:15.666121 django_restit-4.2.88/telephony/migrations/0002_alter_sms_sid.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.666142 django_restit-4.2.88/telephony/migrations/__init__.py
--rw-r--r--   0        0        0     8248 2024-04-13 20:28:15.666266 django_restit-4.2.88/telephony/models.py
--rw-r--r--   0        0        0     5067 2024-04-13 20:28:15.666315 django_restit-4.2.88/telephony/phone_util.py
--rw-r--r--   0        0        0     3473 2024-04-13 20:28:15.666362 django_restit-4.2.88/telephony/rpc.py
--rw-r--r--   0        0        0        1 2024-04-13 20:28:15.666426 django_restit-4.2.88/wiki/__init__.py
--rw-r--r--   0        0        0     3606 2024-04-13 20:28:15.666501 django_restit-4.2.88/wiki/migrations/0001_initial.py
--rw-r--r--   0        0        0      485 2024-05-13 02:34:55.168648 django_restit-4.2.88/wiki/migrations/0002_alter_pagemedia_entry.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.666521 django_restit-4.2.88/wiki/migrations/__init__.py
--rw-r--r--   0        0        0      132 2024-04-13 20:28:15.666590 django_restit-4.2.88/wiki/models/__init__.py
--rw-r--r--   0        0        0     1745 2024-04-13 20:28:15.666635 django_restit-4.2.88/wiki/models/faq.py
--rw-r--r--   0        0        0     7203 2024-04-13 20:28:15.666696 django_restit-4.2.88/wiki/models/page.py
--rw-r--r--   0        0        0      729 2024-04-13 20:28:15.666741 django_restit-4.2.88/wiki/models/revision.py
--rw-r--r--   0        0        0      334 2024-04-13 20:28:15.666791 django_restit-4.2.88/wiki/periodic.py
--rw-r--r--   0        0        0      461 2024-04-13 20:28:15.666864 django_restit-4.2.88/wiki/renderers/__init__.py
--rwxr-xr-x   0        0        0       84 2024-04-13 20:28:15.666938 django_restit-4.2.88/wiki/renderers/mistune/__init__.py
--rwxr-xr-x   0        0        0     1264 2024-04-13 20:28:15.666986 django_restit-4.2.88/wiki/renderers/mistune/highlight.py
--rwxr-xr-x   0        0        0     1901 2024-04-13 20:28:15.667033 django_restit-4.2.88/wiki/renderers/mistune/math.py
--rw-r--r--   0        0        0     2610 2024-04-13 20:28:15.667082 django_restit-4.2.88/wiki/renderers/mistune/media.py
--rwxr-xr-x   0        0        0      805 2024-04-13 20:28:15.667124 django_restit-4.2.88/wiki/renderers/mistune/meta.py
--rw-r--r--   0        0        0     1889 2024-04-13 20:28:15.667169 django_restit-4.2.88/wiki/renderers/mistune/task_list.py
--rwxr-xr-x   0        0        0     2302 2024-04-13 20:28:15.667217 django_restit-4.2.88/wiki/renderers/mistune/toc.py
--rw-r--r--   0        0        0       40 2024-04-13 20:28:15.667294 django_restit-4.2.88/wiki/rpc/__init__.py
--rw-r--r--   0        0        0     1333 2024-04-13 20:28:15.667341 django_restit-4.2.88/wiki/rpc/wiki.py
--rw-r--r--   0        0        0      313 2024-04-13 20:28:15.667390 django_restit-4.2.88/wiki/tq.py
--rw-r--r--   0        0        0     3624 2024-04-13 20:28:15.667476 django_restit-4.2.88/ws4redis/README.md
--rwxr-xr-x   0        0        0       46 2024-04-13 20:28:15.667515 django_restit-4.2.88/ws4redis/__init__.py
--rw-r--r--   0        0        0     7013 2024-04-13 20:28:15.667571 django_restit-4.2.88/ws4redis/client.py
--rw-r--r--   0        0        0    13431 2024-04-13 20:28:15.667695 django_restit-4.2.88/ws4redis/connection.py
--rwxr-xr-x   0        0        0      636 2024-04-13 20:28:15.667746 django_restit-4.2.88/ws4redis/exceptions.py
--rw-r--r--   0        0        0     6093 2024-04-13 20:28:15.667813 django_restit-4.2.88/ws4redis/redis.py
--rw-r--r--   0        0        0        0 2024-04-13 20:28:15.667877 django_restit-4.2.88/ws4redis/servers/__init__.py
--rw-r--r--   0        0        0     3747 2024-04-13 20:28:15.667948 django_restit-4.2.88/ws4redis/servers/base.py
--rw-r--r--   0        0        0     5898 2024-04-30 22:59:33.206473 django_restit-4.2.88/ws4redis/servers/django.py
--rw-r--r--   0        0        0     1723 2024-04-13 20:28:15.668065 django_restit-4.2.88/ws4redis/servers/uwsgi.py
--rwxr-xr-x   0        0        0     1536 2024-04-13 20:28:15.668112 django_restit-4.2.88/ws4redis/settings.py
--rwxr-xr-x   0        0        0     5122 2024-04-13 20:28:15.668166 django_restit-4.2.88/ws4redis/utf8validator.py
--rwxr-xr-x   0        0        0    14848 2024-04-25 19:45:04.792690 django_restit-4.2.88/ws4redis/websocket.py
--rw-r--r--   0        0        0     7645 1970-01-01 00:00:00.000000 django_restit-4.2.88/PKG-INFO
...
### Comparing `django_restit-4.2.88/LICENSE.md` & `django_restit-4.2.9/LICENSE.md`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/README.md` & `django_restit-4.2.9/README.md`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/account/admin.py` & `django_restit-4.2.9/account/admin.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/account/fcm/__init__.py` & `django_restit-4.2.9/account/fcm/__init__.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/account/migrations/0001_initial.py` & `django_restit-4.2.9/account/migrations/0001_initial.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/account/migrations/0003_member_phone_number.py` & `django_restit-4.2.9/account/migrations/0003_member_phone_number.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/account/migrations/0004_group_modified_alter_group_created.py` & `django_restit-4.2.9/account/migrations/0004_group_modified_alter_group_created.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/account/migrations/0007_authtoken_signature_authsession.py` & `django_restit-4.2.9/account/migrations/0007_authtoken_signature_authsession.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/account/migrations/0008_memberdevice_memberdevicemetadata.py` & `django_restit-4.2.9/account/migrations/0008_memberdevice_memberdevicemetadata.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/account/migrations/0011_authtoken.py` & `django_restit-4.2.9/account/migrations/0011_authtoken.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/account/migrations/0012_settings_settingsmetadata.py` & `django_restit-4.2.9/account/migrations/0012_settings_settingsmetadata.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/account/migrations/0014_alter_notificationmemberrecord_member.py` & `django_restit-4.2.9/account/migrations/0014_alter_notificationmemberrecord_member.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/account/migrations/0018_userpasskey.py` & `django_restit-4.2.9/sessionlog/migrations/0001_initial.py`
...
### Comparing `django_restit-4.2.88/account/migrations/0020_cloudcredentials_cloudcredentialsmetadata.py` & `django_restit-4.2.9/incident/migrations/0011_ticket.py`
...
### Comparing `django_restit-4.2.88/account/models/device.py` & `django_restit-4.2.9/account/models/device.py`
...
### Comparing `django_restit-4.2.88/account/models/group.py` & `django_restit-4.2.9/account/models/group.py`
...
### Comparing `django_restit-4.2.88/account/models/legacy.py` & `django_restit-4.2.9/account/models/legacy.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/account/models/member.py` & `django_restit-4.2.9/account/models/member.py`
...
### Comparing `django_restit-4.2.88/account/models/notify.py` & `django_restit-4.2.9/account/models/notify.py`
...
### Comparing `django_restit-4.2.88/account/models/session.py` & `django_restit-4.2.9/account/models/session.py`
...
### Comparing `django_restit-4.2.88/account/models/settings.py` & `django_restit-4.2.9/account/models/settings.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/account/oauth/google.py` & `django_restit-4.2.9/account/oauth/google.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/account/passkeys/core.py` & `django_restit-4.2.9/auditlog/rpc.py`
...
### Comparing `django_restit-4.2.88/account/periodic.py` & `django_restit-4.2.9/account/periodic.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/account/rpc/auth.py` & `django_restit-4.2.9/account/rpc/auth.py`
...
### Comparing `django_restit-4.2.88/account/rpc/device.py` & `django_restit-4.2.9/account/rpc/device.py`
...
### Comparing `django_restit-4.2.88/account/rpc/group.py` & `django_restit-4.2.9/account/rpc/group.py`
...
### Comparing `django_restit-4.2.88/account/rpc/member.py` & `django_restit-4.2.9/account/rpc/member.py`
...
### Comparing `django_restit-4.2.88/account/rpc/notify.py` & `django_restit-4.2.9/account/rpc/notify.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/account/rpc/oauth.py` & `django_restit-4.2.9/account/rpc/oauth.py`
...
### Comparing `django_restit-4.2.88/account/templates/email/base.html` & `django_restit-4.2.9/account/templates/email/base.html`
...
### Comparing `django_restit-4.2.88/account/templates/email/invite.html` & `django_restit-4.2.9/account/templates/email/reset_code.html`
 ...
 * *File "/tmp/diffoscope_i4bo09q9_/tmpcumz3ipl_TarContainer/0/49.html", line 356, column 118: Levels of opening and closing headings don't match*
...
### Comparing `django_restit-4.2.88/account/templates/email/plain/base.html` & `django_restit-4.2.9/account/templates/email/plain/base.html`
...
### Comparing `django_restit-4.2.88/account/templates/email/plain/invite.html` & `django_restit-4.2.9/account/templates/email/plain/invite.html`
...
### Comparing `django_restit-4.2.88/account/templates/email/plain/reset_code.html` & `django_restit-4.2.9/account/templates/email/plain/reset_code.html`
...
### Comparing `django_restit-4.2.88/account/templates/email/reset_code.html` & `django_restit-4.2.9/account/templates/email/invite.html`
 ...
 * *File "/tmp/diffoscope_i4bo09q9_/tmpwgzz8gh7_TarContainer/0/58.html", line 356, column 118: Levels of opening and closing headings don't match*
...
### Comparing `django_restit-4.2.88/account/templates/email/simple/invite.html` & `django_restit-4.2.9/account/templates/email/simple/invite.html`
...
### Comparing `django_restit-4.2.88/account/templates/email/simple/reset_code.html` & `django_restit-4.2.9/account/templates/email/simple/reset_code.html`
...
### Comparing `django_restit-4.2.88/auditlog/README` & `django_restit-4.2.9/auditlog/README`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/auditlog/admin.py` & `django_restit-4.2.9/auditlog/admin.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/auditlog/decorators.py` & `django_restit-4.2.9/auditlog/decorators.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/auditlog/middleware.py` & `django_restit-4.2.9/auditlog/middleware.py`
...
### Comparing `django_restit-4.2.88/auditlog/migrations/0001_initial.py` & `django_restit-4.2.9/auditlog/migrations/0001_initial.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/auditlog/models.py` & `django_restit-4.2.9/auditlog/models.py`
...
### Comparing `django_restit-4.2.88/auditlog/tq.py` & `django_restit-4.2.9/auditlog/tq.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/inbox/README.md` & `django_restit-4.2.9/inbox/README.md`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/inbox/handlers.py` & `django_restit-4.2.9/inbox/handlers.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/inbox/migrations/0001_initial.py` & `django_restit-4.2.9/inbox/migrations/0001_initial.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/inbox/migrations/0004_mailtemplate.py` & `django_restit-4.2.9/inbox/migrations/0004_mailtemplate.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/inbox/models/bounce.py` & `django_restit-4.2.9/inbox/models/bounce.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/inbox/models/complaint.py` & `django_restit-4.2.9/inbox/models/complaint.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/inbox/models/message.py` & `django_restit-4.2.9/inbox/models/message.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/inbox/models/template.py` & `django_restit-4.2.9/inbox/models/template.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/inbox/rpc.py` & `django_restit-4.2.9/inbox/rpc.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/inbox/utils/parsing.py` & `django_restit-4.2.9/inbox/utils/parsing.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/inbox/utils/render.py` & `django_restit-4.2.9/inbox/utils/render.py`
...
### Comparing `django_restit-4.2.88/inbox/utils/sending.py` & `django_restit-4.2.9/inbox/utils/sending.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/incident/README.md` & `django_restit-4.2.9/incident/README.md`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/incident/__init__.py` & `django_restit-4.2.9/incident/__init__.py`
...
### Comparing `django_restit-4.2.88/incident/migrations/0001_initial.py` & `django_restit-4.2.9/incident/migrations/0001_initial.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/incident/migrations/0002_event_component_event_component_id.py` & `django_restit-4.2.9/incident/migrations/0002_event_component_event_component_id.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/incident/migrations/0004_serverossecalert_ssh_sig_alter_rulecheck_parent.py` & `django_restit-4.2.9/incident/migrations/0004_serverossecalert_ssh_sig_alter_rulecheck_parent.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/incident/migrations/0005_incident_component_alter_incident_state.py` & `django_restit-4.2.9/incident/migrations/0005_incident_component_alter_incident_state.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/incident/migrations/0008_incident_action_sent_incident_hostname_and_more.py` & `django_restit-4.2.9/incident/migrations/0008_incident_action_sent_incident_hostname_and_more.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/incident/migrations/0010_incident_category_incident_component_id.py` & `django_restit-4.2.9/incident/migrations/0010_incident_category_incident_component_id.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/incident/migrations/0014_event_group_alter_rulecheck_index.py` & `django_restit-4.2.9/location/migrations/0002_geoip_subnet_alter_geoip_ip.py`
...
### Comparing `django_restit-4.2.88/incident/models/event.py` & `django_restit-4.2.9/incident/models/event.py`
...
### Comparing `django_restit-4.2.88/incident/models/incident.py` & `django_restit-4.2.9/incident/models/incident.py`
...
### Comparing `django_restit-4.2.88/incident/models/ossec.py` & `django_restit-4.2.9/incident/models/ossec.py`
...
### Comparing `django_restit-4.2.88/incident/models/rules.py` & `django_restit-4.2.9/incident/models/rules.py`
...
### Comparing `django_restit-4.2.88/incident/models/ticket.py` & `django_restit-4.2.9/incident/models/ticket.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/incident/rpc.py` & `django_restit-4.2.9/incident/rpc.py`
...
### Comparing `django_restit-4.2.88/incident/templates/email/incident_change.html` & `django_restit-4.2.9/incident/templates/email/incident_change.html`
...
### Comparing `django_restit-4.2.88/incident/templates/email/incident_msg.html` & `django_restit-4.2.9/incident/templates/email/incident_new.html`
...
### Comparing `django_restit-4.2.88/incident/templates/email/incident_new.html` & `django_restit-4.2.9/incident/templates/email/incident_plain.html`
...
### Comparing `django_restit-4.2.88/incident/tq.py` & `django_restit-4.2.9/incident/tq.py`
...
### Comparing `django_restit-4.2.88/location/geolocate.py` & `django_restit-4.2.9/location/geolocate.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/location/migrations/0001_initial.py` & `django_restit-4.2.9/location/migrations/0001_initial.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/location/models/address.py` & `django_restit-4.2.9/location/models/address.py`
...
### Comparing `django_restit-4.2.88/location/models/ip.py` & `django_restit-4.2.9/location/models/ip.py`
...
### Comparing `django_restit-4.2.88/location/models/legacy.py` & `django_restit-4.2.9/location/models/legacy.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/location/models/location.py` & `django_restit-4.2.9/location/models/location.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/location/models/track.py` & `django_restit-4.2.9/location/models/track.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/location/providers/iplookup/__init__.py` & `django_restit-4.2.9/location/providers/iplookup/__init__.py`
...
### Comparing `django_restit-4.2.88/location/providers/iplookup/abstractapi.py` & `django_restit-4.2.9/location/providers/iplookup/abstractapi.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/location/providers/iplookup/extremeip.py` & `django_restit-4.2.9/location/providers/iplookup/extremeip.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/location/providers/iplookup/geoplugin.py` & `django_restit-4.2.9/location/providers/iplookup/geoplugin.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/location/providers/iplookup/ipapi.py` & `django_restit-4.2.9/location/providers/iplookup/ipapi.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/location/providers/iplookup/ipinfo.py` & `django_restit-4.2.9/location/providers/iplookup/ipinfo.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/location/providers/iplookup/restit.py` & `django_restit-4.2.9/location/providers/iplookup/restit.py`
...
### Comparing `django_restit-4.2.88/location/providers/location/google.py` & `django_restit-4.2.9/location/providers/location/google.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/location/providers/timezones/google.py` & `django_restit-4.2.9/location/providers/timezones/google.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/location/providers/zillow.py` & `django_restit-4.2.9/location/providers/zillow.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/location/rpc/ip.py` & `django_restit-4.2.9/location/rpc/ip.py`
...
### Comparing `django_restit-4.2.88/location/rpc/location.py` & `django_restit-4.2.9/location/rpc/location.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/location/rpc/track.py` & `django_restit-4.2.9/location/rpc/track.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/admin.py` & `django_restit-4.2.9/medialib/admin.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/cvutil/contours.py` & `django_restit-4.2.9/medialib/cvutil/contours.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/cvutil/images.py` & `django_restit-4.2.9/medialib/cvutil/images.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/cvutil/misc.py` & `django_restit-4.2.9/medialib/cvutil/misc.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/cvutil/text.py` & `django_restit-4.2.9/medialib/cvutil/text.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/fixtures/initial_data.json` & `django_restit-4.2.9/medialib/fixtures/initial_data.json`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/fixtures/medialib.json` & `django_restit-4.2.9/medialib/fixtures/medialib.json`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/fixtures/medialib_test_fixture.json` & `django_restit-4.2.9/medialib/fixtures/medialib_test_fixture.json`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/forms.py` & `django_restit-4.2.9/medialib/forms.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/migrations/0001_initial.py` & `django_restit-4.2.9/medialib/migrations/0001_initial.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/models.py` & `django_restit-4.2.9/medialib/models.py`
...
### Comparing `django_restit-4.2.88/medialib/ocr.py` & `django_restit-4.2.9/medialib/ocr.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/pdf.py` & `django_restit-4.2.9/medialib/pdf.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/qrcode.py` & `django_restit-4.2.9/medialib/qrcode.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/__init__.py` & `django_restit-4.2.9/medialib/render/__init__.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/engines/anigif.py` & `django_restit-4.2.9/medialib/render/engines/anigif.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/engines/ffmpeg.py` & `django_restit-4.2.9/medialib/render/engines/ffmpeg.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/engines/gifsicle.py` & `django_restit-4.2.9/medialib/render/engines/gifsicle.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/engines/hls.py` & `django_restit-4.2.9/medialib/render/engines/hls.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/engines/mp4box.py` & `django_restit-4.2.9/medialib/render/engines/mp4box.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/engines/rtmp/rtmp.i` & `django_restit-4.2.9/medialib/render/engines/rtmp/rtmp.i`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/engines/rtmpdump.py` & `django_restit-4.2.9/medialib/render/engines/rtmpdump.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/engines/rtmpsink.py` & `django_restit-4.2.9/medialib/render/engines/rtmpsink.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/engines/video_getinfo.py` & `django_restit-4.2.9/medialib/render/engines/video_getinfo.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/engines/websnap.py` & `django_restit-4.2.9/medialib/render/engines/websnap.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/exceptions.py` & `django_restit-4.2.9/medialib/render/exceptions.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/presets/akamai.py` & `django_restit-4.2.9/medialib/render/presets/akamai.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/presets/animated_thumbnail.py` & `django_restit-4.2.9/medialib/render/presets/animated_thumbnail.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/presets/ffmpeg.py` & `django_restit-4.2.9/medialib/render/presets/ffmpeg.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/presets/flv.py` & `django_restit-4.2.9/medialib/render/presets/flv.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/presets/hls.py` & `django_restit-4.2.9/medialib/render/presets/hls.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/presets/image_transcode.py` & `django_restit-4.2.9/medialib/render/presets/image_transcode.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/presets/image_validate.py` & `django_restit-4.2.9/medialib/render/presets/image_validate.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/presets/mp4.py` & `django_restit-4.2.9/medialib/render/presets/mp4.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/presets/video_still.py` & `django_restit-4.2.9/medialib/render/presets/video_still.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/presets/video_validate.py` & `django_restit-4.2.9/medialib/render/presets/video_validate.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/presets/websnap.py` & `django_restit-4.2.9/medialib/render/presets/websnap.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/presets/youtube.py` & `django_restit-4.2.9/medialib/render/presets/youtube.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/render/render_utils.py` & `django_restit-4.2.9/medialib/render/render_utils.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/rpc/legacy.py` & `django_restit-4.2.9/medialib/rpc/legacy.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/rpc/media.py` & `django_restit-4.2.9/medialib/rpc/media.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/rpc/tools.py` & `django_restit-4.2.9/medialib/rpc/tools.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/scripts/init_config` & `django_restit-4.2.9/medialib/scripts/init_config`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/static/css/base_medialibui.css` & `django_restit-4.2.9/medialib/static/css/base_medialibui.css`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/static/css/base_widgets.css` & `django_restit-4.2.9/medialib/static/css/base_widgets.css`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/static/css/jquery.jcrop.css` & `django_restit-4.2.9/medialib/static/css/jquery.jcrop.css`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/static/img/bg-body.gif` & `django_restit-4.2.9/medialib/static/img/bg-body.gif`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/static/img/loading.gif` & `django_restit-4.2.9/medialib/static/img/loading.gif`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/static/img/noimage.gif` & `django_restit-4.2.9/medialib/static/img/noimage.gif`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/static/img/render_err.gif` & `django_restit-4.2.9/medialib/static/img/render_err.gif`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/static/img/rendering.gif` & `django_restit-4.2.9/medialib/static/img/rendering.gif`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/static/img/unknown.gif` & `django_restit-4.2.9/medialib/static/img/unknown.gif`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/static/lib/caman.full.js` & `django_restit-4.2.9/medialib/static/lib/caman.full.js`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/static/lib/hammer.min.js` & `django_restit-4.2.9/medialib/static/lib/hammer.min.js`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/static/lib/jquery.Jcrop.js` & `django_restit-4.2.9/medialib/static/lib/jquery.Jcrop.js`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/static/lib/jquery.hammer.js` & `django_restit-4.2.9/medialib/static/lib/jquery.hammer.js`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/static/lib/load-image.min.js` & `django_restit-4.2.9/medialib/static/lib/load-image.min.js`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/static/lib/swiper.js` & `django_restit-4.2.9/medialib/static/lib/swiper.js`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/static/lib/tinymce/plugins/medialib/editor_plugin.js` & `django_restit-4.2.9/medialib/static/lib/tinymce/plugins/medialib/editor_plugin.js`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/static/lib/tinymce/plugins/medialib/editor_plugin_src.js` & `django_restit-4.2.9/medialib/static/lib/tinymce/plugins/medialib/editor_plugin_src.js`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/static/lib/tinymce/plugins/medialib/js/dialog.js` & `django_restit-4.2.9/medialib/static/lib/tinymce/plugins/medialib/js/dialog.js`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/static/lib/tinymce/plugins/medialib/medialib.html` & `django_restit-4.2.9/medialib/static/lib/tinymce/plugins/medialib/medialib.html`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/__init__.py` & `django_restit-4.2.9/medialib/stores/__init__.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/apiclient/__init__.py` & `django_restit-4.2.9/medialib/stores/apiclient/__init__.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/apiclient/channel.py` & `django_restit-4.2.9/medialib/stores/apiclient/channel.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/apiclient/discovery.py` & `django_restit-4.2.9/medialib/stores/apiclient/discovery.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/apiclient/errors.py` & `django_restit-4.2.9/medialib/stores/apiclient/errors.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/apiclient/http.py` & `django_restit-4.2.9/medialib/stores/apiclient/http.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/apiclient/mimeparse.py` & `django_restit-4.2.9/medialib/stores/apiclient/mimeparse.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/apiclient/model.py` & `django_restit-4.2.9/medialib/stores/apiclient/model.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/apiclient/sample_tools.py` & `django_restit-4.2.9/medialib/stores/apiclient/sample_tools.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/apiclient/schema.py` & `django_restit-4.2.9/medialib/stores/apiclient/schema.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/filestore.py` & `django_restit-4.2.9/medialib/stores/filestore.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/httplib2/__init__.py` & `django_restit-4.2.9/medialib/stores/httplib2/__init__.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/httplib2/cacerts.txt` & `django_restit-4.2.9/medialib/stores/httplib2/cacerts.txt`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/httplib2/iri2uri.py` & `django_restit-4.2.9/medialib/stores/httplib2/iri2uri.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/httplib2/socks.py` & `django_restit-4.2.9/medialib/stores/httplib2/socks.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/httpstore.py` & `django_restit-4.2.9/medialib/stores/httpstore.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/oauth2client/anyjson.py` & `django_restit-4.2.9/medialib/stores/oauth2client/anyjson.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/oauth2client/appengine.py` & `django_restit-4.2.9/medialib/stores/oauth2client/appengine.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/oauth2client/client.py` & `django_restit-4.2.9/medialib/stores/oauth2client/client.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/oauth2client/clientsecrets.py` & `django_restit-4.2.9/medialib/stores/oauth2client/clientsecrets.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/oauth2client/crypt.py` & `django_restit-4.2.9/medialib/stores/oauth2client/crypt.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/oauth2client/django_orm.py` & `django_restit-4.2.9/medialib/stores/oauth2client/django_orm.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/oauth2client/file.py` & `django_restit-4.2.9/medialib/stores/oauth2client/file.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/oauth2client/gce.py` & `django_restit-4.2.9/medialib/stores/oauth2client/gce.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/oauth2client/keyring_storage.py` & `django_restit-4.2.9/medialib/stores/oauth2client/keyring_storage.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/oauth2client/locked_file.py` & `django_restit-4.2.9/medialib/stores/oauth2client/locked_file.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/oauth2client/multistore_file.py` & `django_restit-4.2.9/medialib/stores/oauth2client/multistore_file.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/oauth2client/old_run.py` & `django_restit-4.2.9/medialib/stores/oauth2client/old_run.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/oauth2client/tools.py` & `django_restit-4.2.9/medialib/stores/oauth2client/tools.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/oauth2client/util.py` & `django_restit-4.2.9/medialib/stores/oauth2client/util.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/oauth2client/xsrfutil.py` & `django_restit-4.2.9/medialib/stores/oauth2client/xsrfutil.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/s3store.py` & `django_restit-4.2.9/medialib/stores/s3store.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/stores/uritemplate/__init__.py` & `django_restit-4.2.9/medialib/stores/uritemplate/__init__.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/templates/medialib/base.html` & `django_restit-4.2.9/medialib/templates/medialib/base.html`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/templates/medialib/instances.html` & `django_restit-4.2.9/medialib/templates/medialib/instances.html`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/templates/medialib/items.html` & `django_restit-4.2.9/medialib/templates/medialib/items.html`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/templates/medialib/library.html` & `django_restit-4.2.9/medialib/templates/medialib/library.html`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/templates/medialib/test.html` & `django_restit-4.2.9/medialib/templates/medialib/test.html`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/templates/medialib/testpicker.html` & `django_restit-4.2.9/medialib/templates/medialib/testpicker.html`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/tests.py` & `django_restit-4.2.9/medialib/tests.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/tq.py` & `django_restit-4.2.9/medialib/tq.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/utils.py` & `django_restit-4.2.9/medialib/utils.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/views.py` & `django_restit-4.2.9/medialib/views.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/__init__.py` & `django_restit-4.2.9/medialib/youtube/__init__.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/apiclient/__init__.py` & `django_restit-4.2.9/medialib/youtube/apiclient/__init__.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/apiclient/channel.py` & `django_restit-4.2.9/medialib/youtube/apiclient/channel.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/apiclient/discovery.py` & `django_restit-4.2.9/medialib/youtube/apiclient/discovery.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/apiclient/errors.py` & `django_restit-4.2.9/medialib/youtube/apiclient/errors.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/apiclient/http.py` & `django_restit-4.2.9/medialib/youtube/apiclient/http.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/apiclient/mimeparse.py` & `django_restit-4.2.9/medialib/youtube/apiclient/mimeparse.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/apiclient/model.py` & `django_restit-4.2.9/medialib/youtube/apiclient/model.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/apiclient/sample_tools.py` & `django_restit-4.2.9/medialib/youtube/apiclient/sample_tools.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/apiclient/schema.py` & `django_restit-4.2.9/medialib/youtube/apiclient/schema.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/httplib2/__init__.py` & `django_restit-4.2.9/medialib/youtube/httplib2/__init__.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/httplib2/cacerts.txt` & `django_restit-4.2.9/medialib/youtube/httplib2/cacerts.txt`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/httplib2/iri2uri.py` & `django_restit-4.2.9/medialib/youtube/httplib2/iri2uri.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/httplib2/socks.py` & `django_restit-4.2.9/medialib/youtube/httplib2/socks.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/oauth2client/anyjson.py` & `django_restit-4.2.9/medialib/youtube/oauth2client/anyjson.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/oauth2client/appengine.py` & `django_restit-4.2.9/medialib/youtube/oauth2client/appengine.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/oauth2client/client.py` & `django_restit-4.2.9/medialib/youtube/oauth2client/client.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/oauth2client/clientsecrets.py` & `django_restit-4.2.9/medialib/youtube/oauth2client/clientsecrets.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/oauth2client/crypt.py` & `django_restit-4.2.9/medialib/youtube/oauth2client/crypt.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/oauth2client/django_orm.py` & `django_restit-4.2.9/medialib/youtube/oauth2client/django_orm.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/oauth2client/file.py` & `django_restit-4.2.9/medialib/youtube/oauth2client/file.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/oauth2client/gce.py` & `django_restit-4.2.9/medialib/youtube/oauth2client/gce.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/oauth2client/keyring_storage.py` & `django_restit-4.2.9/medialib/youtube/oauth2client/keyring_storage.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/oauth2client/locked_file.py` & `django_restit-4.2.9/medialib/youtube/oauth2client/locked_file.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/oauth2client/multistore_file.py` & `django_restit-4.2.9/medialib/youtube/oauth2client/multistore_file.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/oauth2client/old_run.py` & `django_restit-4.2.9/medialib/youtube/oauth2client/old_run.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/oauth2client/tools.py` & `django_restit-4.2.9/medialib/youtube/oauth2client/tools.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/oauth2client/util.py` & `django_restit-4.2.9/medialib/youtube/oauth2client/util.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/oauth2client/xsrfutil.py` & `django_restit-4.2.9/medialib/youtube/oauth2client/xsrfutil.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/upload.py` & `django_restit-4.2.9/medialib/youtube/upload.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/medialib/youtube/uritemplate/__init__.py` & `django_restit-4.2.9/medialib/youtube/uritemplate/__init__.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/metrics/README.md` & `django_restit-4.2.9/metrics/README.md`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/metrics/client.py` & `django_restit-4.2.9/metrics/client.py`
...
### Comparing `django_restit-4.2.88/metrics/eod.py` & `django_restit-4.2.9/metrics/eod.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/metrics/examples/eod_example.py` & `django_restit-4.2.9/metrics/examples/eod_example.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/metrics/management/commands/fix_redis_metrics_keys.py` & `django_restit-4.2.9/metrics/management/commands/fix_redis_metrics_keys.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/metrics/management/commands/generate_test_metrics.py` & `django_restit-4.2.9/metrics/management/commands/generate_test_metrics.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/metrics/management/commands/redis_metrics_send_mail.py` & `django_restit-4.2.9/metrics/management/commands/redis_metrics_send_mail.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/metrics/management/commands/reset_weekly_metrics.py` & `django_restit-4.2.9/metrics/management/commands/reset_weekly_metrics.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/metrics/management/commands/system_metric.py` & `django_restit-4.2.9/metrics/management/commands/system_metric.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/metrics/migrations/0001_initial.py` & `django_restit-4.2.9/metrics/migrations/0001_initial.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/metrics/migrations/0002_metrics_k11_metrics_k12_metrics_k13_metrics_k14_and_more.py` & `django_restit-4.2.9/metrics/migrations/0002_metrics_k11_metrics_k12_metrics_k13_metrics_k14_and_more.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/metrics/migrations/0004_eodmetrics.py` & `django_restit-4.2.9/metrics/migrations/0004_eodmetrics.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/metrics/migrations/0005_alter_metrics_v1_alter_metrics_v10_alter_metrics_v11_and_more.py` & `django_restit-4.2.9/metrics/migrations/0005_alter_metrics_v1_alter_metrics_v10_alter_metrics_v11_and_more.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/metrics/models.py` & `django_restit-4.2.9/metrics/models.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/metrics/periodic.py` & `django_restit-4.2.9/metrics/periodic.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/metrics/providers/aws.py` & `django_restit-4.2.9/metrics/providers/aws.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/metrics/rpc.py` & `django_restit-4.2.9/metrics/rpc.py`
...
### Comparing `django_restit-4.2.88/metrics/tq.py` & `django_restit-4.2.9/metrics/tq.py`
...
### Comparing `django_restit-4.2.88/metrics/utils.py` & `django_restit-4.2.9/metrics/utils.py`
...
### Comparing `django_restit-4.2.88/pushit/migrations/0001_initial.py` & `django_restit-4.2.9/pushit/migrations/0001_initial.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/pushit/models.py` & `django_restit-4.2.9/pushit/models.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/pushit/rpc/githooks.py` & `django_restit-4.2.9/pushit/rpc/githooks.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/pushit/rpc/legacy.py` & `django_restit-4.2.9/pushit/rpc/legacy.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/pushit/utils.py` & `django_restit-4.2.9/pushit/utils.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/pyproject.toml` & `django_restit-4.2.9/pyproject.toml`
...
### Comparing `django_restit-4.2.88/rest/README.md` & `django_restit-4.2.9/rest/README.md`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/arc4.py` & `django_restit-4.2.9/rest/arc4.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/crypto/aes.py` & `django_restit-4.2.9/rest/crypto/aes.py`
...
### Comparing `django_restit-4.2.88/rest/crypto/privpub.py` & `django_restit-4.2.9/rest/crypto/privpub.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/crypto/util.py` & `django_restit-4.2.9/rest/crypto/util.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/datem.py` & `django_restit-4.2.9/rest/datem.py`
...
### Comparing `django_restit-4.2.88/rest/decorators.py` & `django_restit-4.2.9/rest/decorators.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/encryption.py` & `django_restit-4.2.9/rest/encryption.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/errors.py` & `django_restit-4.2.9/rest/errors.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/extra/json_metadata.py` & `django_restit-4.2.9/rest/extra/json_metadata.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/fields.py` & `django_restit-4.2.9/rest/fields.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/forms.py` & `django_restit-4.2.9/rest/forms.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/helpers.py` & `django_restit-4.2.9/rest/helpers.py`
...
### Comparing `django_restit-4.2.88/rest/jwtoken.py` & `django_restit-4.2.9/rest/jwtoken.py`
...
### Comparing `django_restit-4.2.88/rest/log.py` & `django_restit-4.2.9/rest/log.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/mail.py` & `django_restit-4.2.9/rest/mail.py`
...
### Comparing `django_restit-4.2.88/rest/mailman.py` & `django_restit-4.2.9/rest/mailman.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/middleware/cors.py` & `django_restit-4.2.9/rest/middleware/cors.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/middleware/db_router.py` & `django_restit-4.2.9/rest/middleware/db_router.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/middleware/jwt.py` & `django_restit-4.2.9/rest/middleware/jwt.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/middleware/request.py` & `django_restit-4.2.9/rest/middleware/request.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/middleware/session.py` & `django_restit-4.2.9/rest/middleware/session.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/middleware/session_store.py` & `django_restit-4.2.9/rest/middleware/session_store.py`
...
### Comparing `django_restit-4.2.88/rest/models/base.py` & `django_restit-4.2.9/rest/models/base.py`
...
### Comparing `django_restit-4.2.88/rest/models/cacher.py` & `django_restit-4.2.9/rest/models/cacher.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/models/metadata.py` & `django_restit-4.2.9/rest/models/metadata.py`
...
### Comparing `django_restit-4.2.88/rest/regexes.yaml` & `django_restit-4.2.9/rest/regexes.yaml`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/requestex.py` & `django_restit-4.2.9/rest/requestex.py`
...
### Comparing `django_restit-4.2.88/rest/rpc.py` & `django_restit-4.2.9/rest/rpc.py`
...
### Comparing `django_restit-4.2.88/rest/search.py` & `django_restit-4.2.9/rest/search.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/serializers/collection.py` & `django_restit-4.2.9/rest/serializers/collection.py`
...
### Comparing `django_restit-4.2.88/rest/serializers/csv.py` & `django_restit-4.2.9/rest/serializers/csv.py`
...
### Comparing `django_restit-4.2.88/rest/serializers/excel.py` & `django_restit-4.2.9/rest/serializers/excel.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/serializers/json.py` & `django_restit-4.2.9/rest/serializers/json.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/serializers/legacy.py` & `django_restit-4.2.9/rest/serializers/legacy.py`
...
### Comparing `django_restit-4.2.88/rest/serializers/model.py` & `django_restit-4.2.9/rest/serializers/model.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/serializers/profiler.py` & `django_restit-4.2.9/rest/serializers/profiler.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/serializers/response.py` & `django_restit-4.2.9/rest/serializers/response.py`
...
### Comparing `django_restit-4.2.88/rest/serializers/util.py` & `django_restit-4.2.9/rest/serializers/util.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/settings_helper.py` & `django_restit-4.2.9/rest/settings_helper.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/ssl_check.py` & `django_restit-4.2.9/rest/ssl_check.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/static/lib/jquery.js` & `django_restit-4.2.9/rest/static/lib/jquery.js`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/templates/email/error.html` & `django_restit-4.2.9/rest/templates/email/error.html`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/templates/rest_docs.html` & `django_restit-4.2.9/rest/templates/rest_docs.html`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/templates/rest_html.html` & `django_restit-4.2.9/rest/templates/rest_html.html`
...
### Comparing `django_restit-4.2.88/rest/ua.py` & `django_restit-4.2.9/rest/ua.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/uberdict.py` & `django_restit-4.2.9/rest/uberdict.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/url_docs.py` & `django_restit-4.2.9/rest/url_docs.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/rest/urls.py` & `django_restit-4.2.9/rest/urls.py`
...
### Comparing `django_restit-4.2.88/rest/views.py` & `django_restit-4.2.9/rest/views.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/sessionlog/models.py` & `django_restit-4.2.9/sessionlog/models.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/taskqueue/README.md` & `django_restit-4.2.9/taskqueue/README.md`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/taskqueue/migrations/0001_initial.py` & `django_restit-4.2.9/taskqueue/migrations/0001_initial.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/taskqueue/models.py` & `django_restit-4.2.9/taskqueue/models.py`
...
### Comparing `django_restit-4.2.88/taskqueue/periodic.py` & `django_restit-4.2.9/taskqueue/periodic.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/taskqueue/rpc.py` & `django_restit-4.2.9/taskqueue/rpc.py`
...
### Comparing `django_restit-4.2.88/taskqueue/tq.py` & `django_restit-4.2.9/taskqueue/tq.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/taskqueue/transports/email.py` & `django_restit-4.2.9/taskqueue/transports/email.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/taskqueue/transports/s3.py` & `django_restit-4.2.9/taskqueue/transports/s3.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/taskqueue/transports/sftp.py` & `django_restit-4.2.9/taskqueue/transports/sftp.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/taskqueue/worker.py` & `django_restit-4.2.9/taskqueue/worker.py`
...
### Comparing `django_restit-4.2.88/telephony/migrations/0001_initial.py` & `django_restit-4.2.9/telephony/migrations/0001_initial.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/telephony/models.py` & `django_restit-4.2.9/telephony/models.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/telephony/rpc.py` & `django_restit-4.2.9/telephony/rpc.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/wiki/migrations/0001_initial.py` & `django_restit-4.2.9/wiki/migrations/0001_initial.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/wiki/models/faq.py` & `django_restit-4.2.9/wiki/models/faq.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/wiki/models/page.py` & `django_restit-4.2.9/wiki/models/page.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/wiki/models/revision.py` & `django_restit-4.2.9/wiki/models/revision.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/wiki/renderers/mistune/highlight.py` & `django_restit-4.2.9/wiki/renderers/mistune/highlight.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/wiki/renderers/mistune/math.py` & `django_restit-4.2.9/wiki/renderers/mistune/math.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/wiki/renderers/mistune/media.py` & `django_restit-4.2.9/wiki/renderers/mistune/media.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/wiki/renderers/mistune/meta.py` & `django_restit-4.2.9/wiki/renderers/mistune/meta.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/wiki/renderers/mistune/task_list.py` & `django_restit-4.2.9/wiki/renderers/mistune/task_list.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/wiki/renderers/mistune/toc.py` & `django_restit-4.2.9/wiki/renderers/mistune/toc.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/wiki/rpc/wiki.py` & `django_restit-4.2.9/wiki/rpc/wiki.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/ws4redis/README.md` & `django_restit-4.2.9/ws4redis/README.md`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/ws4redis/connection.py` & `django_restit-4.2.9/ws4redis/connection.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/ws4redis/exceptions.py` & `django_restit-4.2.9/ws4redis/exceptions.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/ws4redis/redis.py` & `django_restit-4.2.9/ws4redis/redis.py`
...
### Comparing `django_restit-4.2.88/ws4redis/servers/base.py` & `django_restit-4.2.9/ws4redis/servers/base.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/ws4redis/servers/django.py` & `django_restit-4.2.9/ws4redis/servers/django.py`
...
### Comparing `django_restit-4.2.88/ws4redis/servers/uwsgi.py` & `django_restit-4.2.9/ws4redis/servers/uwsgi.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/ws4redis/settings.py` & `django_restit-4.2.9/ws4redis/settings.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/ws4redis/utf8validator.py` & `django_restit-4.2.9/ws4redis/utf8validator.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/ws4redis/websocket.py` & `django_restit-4.2.9/ws4redis/websocket.py`

 * *Files identical despite different names*

### Comparing `django_restit-4.2.88/PKG-INFO` & `django_restit-4.2.9/PKG-INFO`
