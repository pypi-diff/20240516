# Comparing `tmp/imsciences-0.5.6.2.tar.gz` & `tmp/imsciences-0.5.6.3.tar.gz`
...
## Comparing `imsciences-0.5.6.2.tar` & `imsciences-0.5.6.3.tar`
...
### Comparing `imsciences-0.5.6.2/PKG-INFO` & `imsciences-0.5.6.3/PKG-INFO`
...
### Comparing `imsciences-0.5.6.2/README.md` & `imsciences-0.5.6.3/README.md`

 * *Files identical despite different names*

### Comparing `imsciences-0.5.6.2/imsciences/datafunctions.py` & `imsciences-0.5.6.3/imsciences/datafunctions.py`
...
### Comparing `imsciences-0.5.6.2/imsciences.egg-info/PKG-INFO` & `imsciences-0.5.6.3/imsciences.egg-info/PKG-INFO`
...
### Comparing `imsciences-0.5.6.2/setup.py` & `imsciences-0.5.6.3/setup.py`
