# Comparing `tmp/taskara-0.1.70.tar.gz` & `tmp/taskara-0.1.8.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "taskara-0.1.70.tar", max compression
+gzip compressed data, was "taskara-0.1.8.tar", max compression
```

## Comparing `taskara-0.1.70.tar` & `taskara-0.1.8.tar`

### file list

```diff
@@ -1,25 +1,10 @@
--rw-r--r--   0        0        0     1069 2024-04-17 17:09:32.374116 taskara-0.1.70/LICENSE
--rw-r--r--   0        0        0     2060 2024-05-10 21:56:27.353796 taskara-0.1.70/README.md
--rw-r--r--   0        0        0     1149 2024-05-15 22:22:47.512183 taskara-0.1.70/pyproject.toml
--rw-r--r--   0        0        0       81 2024-04-30 21:36:12.359132 taskara-0.1.70/taskara/__init__.py
--rw-r--r--   0        0        0     1725 2024-04-30 21:35:45.162984 taskara-0.1.70/taskara/agent.py
--rw-r--r--   0        0        0       23 2024-04-25 16:52:45.140876 taskara-0.1.70/taskara/auth/default.py
--rw-r--r--   0        0        0     2548 2024-05-14 17:57:30.200785 taskara-0.1.70/taskara/auth/key.py
--rw-r--r--   0        0        0     3084 2024-05-15 18:54:23.139181 taskara-0.1.70/taskara/auth/provider.py
--rw-r--r--   0        0        0     1400 2024-05-15 19:45:37.713383 taskara-0.1.70/taskara/auth/transport.py
--rw-r--r--   0        0        0     3250 2024-05-15 02:15:10.300615 taskara-0.1.70/taskara/cli/main.py
--rw-r--r--   0        0        0     2489 2024-05-15 01:50:26.307921 taskara-0.1.70/taskara/db/conn.py
--rw-r--r--   0        0        0     1646 2024-05-14 16:50:52.287826 taskara-0.1.70/taskara/db/models.py
--rw-r--r--   0        0        0      195 2024-04-30 21:35:42.361364 taskara-0.1.70/taskara/env.py
--rw-r--r--   0        0        0     1520 2024-04-30 21:35:40.978077 taskara-0.1.70/taskara/metrics.py
--rw-r--r--   0        0        0    11644 2024-05-15 20:20:23.953466 taskara-0.1.70/taskara/runtime/base.py
--rw-r--r--   0        0        0    11143 2024-05-15 20:33:03.566097 taskara-0.1.70/taskara/runtime/docker.py
--rw-r--r--   0        0        0    28397 2024-05-15 18:51:10.892463 taskara-0.1.70/taskara/runtime/kube.py
--rw-r--r--   0        0        0     2035 2024-05-14 16:09:34.524064 taskara-0.1.70/taskara/runtime/load.py
--rw-r--r--   0        0        0    13561 2024-05-15 02:35:06.365646 taskara-0.1.70/taskara/runtime/process.py
--rw-r--r--   0        0        0     2524 2024-05-15 01:55:50.871200 taskara-0.1.70/taskara/server/app.py
--rw-r--r--   0        0        0     2660 2024-05-14 16:33:48.316998 taskara-0.1.70/taskara/server/models.py
--rw-r--r--   0        0        0     6327 2024-05-15 02:32:23.524217 taskara-0.1.70/taskara/server/router/tasks.py
--rw-r--r--   0        0        0    31467 2024-05-15 22:22:40.460026 taskara-0.1.70/taskara/task.py
--rw-r--r--   0        0        0     1810 2024-05-14 20:41:39.421321 taskara-0.1.70/taskara/util.py
--rw-r--r--   0        0        0     3314 1970-01-01 00:00:00.000000 taskara-0.1.70/PKG-INFO
...
### Comparing `taskara-0.1.70/taskara/db/conn.py` & `taskara-0.1.8/taskara/db/conn.py`
...
### Comparing `taskara-0.1.70/taskara/db/models.py` & `taskara-0.1.8/taskara/db/models.py`
